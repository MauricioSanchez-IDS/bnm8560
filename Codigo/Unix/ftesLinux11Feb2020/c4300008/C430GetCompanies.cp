...
#endif                                       
{
   EXEC SQL BEGIN DECLARE SECTION;
      ...
      char sCadConexion[150+1];    /* Cadena de Conexion. */
   ...
   sprintf(sCadConexion, "udi=%s;pwd=%s;dbf=%s;keepormultibyte=1;EncriptPassword=1",sUsername,sPassword,sServer);  

   /* Conexion al servidor de SYBASE. */
   EXEC SQL CONNECT USING sCadConexion;
