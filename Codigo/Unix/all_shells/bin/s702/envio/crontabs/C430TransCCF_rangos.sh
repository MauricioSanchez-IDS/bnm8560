...
LAServer=$ServerSYB
LAProgram=$BinPath"C430TransCCF_rangos"
...
#    echo "OK $LAProgram $LAUser $LAPassword $LAServer $LAFileType $LAFileRange $LAFileName $LACoPreffix $LABankGroup $LACompanyID $LAProcessDate1 $LAProcessDateTransCCFcp"
    $LAProgram $LAUser $LAPassword $LAServer $LAFileType $LAFileRange $LAFileName $LACoPreffix $LABankGroup $LACompanyID $LAProcessDate1 $LAProcessDateTransCCFcp
...
echo "COMANDO $LAProgram $LAUser $LAPassword $LAServer $LAFileType $LAFileRange $LAFileName $LACoPreffix $LABankGroup $LACompanyID $LAProcessDate1 $LAProcessDateTransCCFcp"
      $LAProgram $LAUser $LAPassword $LAServer $LAFileType $LAFileRange $LAFileName $LACoPreffix $LABankGroup $LACompanyID $LAProcessDate1 $LAProcessDateTransCCFcp
