...
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/eje.sql -Jroman8 > $DIR_TEMP/eje1.txt
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/eje2.sql -Jroman8 > $DIR_TEMP/eje2.txt
