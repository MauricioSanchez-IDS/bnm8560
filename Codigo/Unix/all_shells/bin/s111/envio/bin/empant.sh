...
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/emp1.sql > $DIR_TEMP/emp1.txt
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/emp2.sql > $DIR_TEMP/emp2.txt
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/emp3.sql > $DIR_TEMP/emp3.txt
isql -U $USUARIO -P $PASSWORD -D$(base.sh) -S $SERVIDOR -i $DIR_TRAB/emp6.sql > $DIR_TEMP/emp6.txt
