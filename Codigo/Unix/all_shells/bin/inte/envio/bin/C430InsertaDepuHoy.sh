...
# Procedimiento: C430InsertaDepuHoy.sh
# Descripción:
# Versión y fecha: 1.0
# Autor: YMF    02/02/08
# Modificaciones: 
# proposito: Inserta Registros en MTCPRO03 para anuanciar             
#            que ya corrio el proceso de depuracion
#            de Reportes de la fecha proporcionada como parametro
...
("$fechaHoy","$HORA","DepuraReportes$1",1,"Se depuraron Reportes  del directorio deposito ")
go
EOF`
