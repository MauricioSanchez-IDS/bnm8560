...
# Procedimiento: C430InsertaDebdHoy.sh
# Descripción:
# Versión y fecha: 1.0
# Autor: YMF    02/02/08
# Modificaciones: 
# proposito: Inserta Registros en MTCPRO03 para anuanciar             
#            que ya corrio el proceso de Reportes de debito
#            de la fecha proporcionada como parametro
...
("$fechaHoy","$HORA","ReportesDebito$1",1,"Se ejecuto Reportes Debito  ")
go
EOF`
