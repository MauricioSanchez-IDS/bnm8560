...
# Descripcion           : Barredora del C430 de Tarjeta Ejecutiva
# Version               : 1.0
# Autor                 :
...
exec 1>>$(paths.sh 01 LOG)/C430BarredoraD.log  
exec 2>&1                                  
...
echo Inicia Barredora Tarjeta Ejecutiva ...
...
isql -U$(usuario.sh) -P$(password.sh) -S$(servidor.sh) -D$(base.sh) -b -w 132 -o $DIR_TEMP/SalBarredoraD.txt <<EOF
...
Where a.eje_prefijo = 5584 and a.gpo_banco = 26
go
...
echo Finaliza Barredora Tarjeta Ejecutiva
