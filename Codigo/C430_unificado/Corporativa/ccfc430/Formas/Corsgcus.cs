...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private bool Valida_Datos()
        {
            ...
            {
                this.Cursor = Cursors.Default;
                MessageBox.Show("No se admite el espacio en el campo Usuario.", "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return false;
            }
            ...
            {
                this.Cursor = Cursors.Default;
                MessageBox.Show("La longitud del Usuario no puede ser menor de 6 caracteres.", "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return false;
            }
