...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void FillFormTestData()
        {
            try
            {
                ID_MEM_FEC_VEN_DTB.CtlText = DateTime.Now.AddYears(1).ToString("dd/MM/yyyy");
                ...
                if (TestData.TestDataAltas.ExistTest())
                {
                    ...
                    TestData.TestDataAltas.MoveTestFile();
                }
                /*
                ID_MEM_NLG_EB.Text = "LA HERRADURA SA DE CV";
                ID_MEM_NCT_EB.Text = "LA HERRADURA";
                ID_MEM_RFC_MKE.CtlText = "EDF-490120-EDF";
                ID_MEM_PAC_EB.Text = "JUAN PEREZ PEREZ";
                ID_MEM_CRE_FTB.CtlText = "60000";

                ID_MEM_DOM_EB[0].Text = "EUGENIA 123";
                ID_MEM_COL_EB[0].Text = "NARVARTE";
                ID_MEM_PDM_EB[0].Text = "BENITO JUAREZ";
                ID_MEM_CIU_EB[0].Text = "CDMX";
                ID_MEM_EDO_EB[0].SelectedIndex = 8;
                ID_MEM_CP_PIC[0].CtlText = "02030";
                ID_MEM_CON_TXT.Text = "55546005";
                ID_MEM_TEL_EXT_TXT.Text = "456";
                ID_MEM_LADA_TXT.Text = "";
                ID_MEM_FAX_TXT.Text = "";
                ID_MEM_FAX_LADA_TXT.Text = "";
                ID_MEM_EMAIL_TXT.Text = "";

                ID_MEM_DOM_EB[1].Text = "eugenia 456";
                ID_MEM_COL_EB[1].Text = "narvarte";
                ID_MEM_PDM_EB[1].Text = "benito juarez";
                ID_MEM_CIU_EB[1].Text = "cdmx";
                ID_MEM_EDO_EB[1].SelectedIndex = 8;
                ID_MEM_CP_PIC[1].CtlText = "02030";

                ID_MEM_SUC_ITB.CtlText = "4191";
                ID_MEM_NMC_FTB.CtlText = "622";

                ID_MEM_NOM_EB[0].Text = "JUAN PEREZ PEREZ";
                ID_MEM_PUE_EB[0].Text = "GERENTE";
                ID_MEM_TEL_MKE[0].CtlText = "658111";

                mskPorcientoMinimo1.CtlText = "013";
                mskPeriodoGracia.CtlText = "10";
                mskDiaCorte.CtlText = "15";
                mskPerNoInteres.CtlText = "10";*/
            }
            catch (Exception ex)
            {
