...
namespace TCc430
{
	internal partial class frmCtasNvas
		: System.Windows.Forms.Form
		{
					...
					try
					{
							...
							if (VBSQL.OpenConn(10) == 0)
							{
								...
								if (! adorst.BOF && ! adorst.EOF)
								{
                                    ...
                                    strfile = mdlParametros.sgPathRepEmpresas +"\\"+"RepCtasNvas" + DateTime.Today.ToString("yyyyMMdd") + ".txt";
			...
			{
					this.Width = (int) VB6.TwipsToPixelsX(6675);//5505
					this.Height = (int) VB6.TwipsToPixelsY(2225);//1695
