...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void ID_CGR_BAJ_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                MessageBox.Show("Fallo operación ID_CGR_BAJ_PB_Click " + exc.Message, "Error Corctgru", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_CGR_CAM_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                MessageBox.Show("Fallo operación ID_CGR_CAM_PB_Click " + exc.Message, "Error Corctgru", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void ID_CGR_CON_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                MessageBox.Show("Fallo operación ID_CGR_CON_PB_Click " + exc.Message, "Error Corctgru", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally
            {
                this.Cursor = Cursors.Default;
