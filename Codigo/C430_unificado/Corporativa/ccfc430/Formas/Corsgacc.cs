...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
            ...
            if ((sValor.Trim().ToUpper() == "TRUE") || (sValor.Trim().ToUpper() == "VERDADERO"))
            {
                switch (sOpcion.Trim())
                {
                    ...
                    case "IDM_ALTAS_MASIVAS":  //archivos/altas masivas 
                        ...
                        break;
                    case "mnuEnvioLimCred":  //archivos/envio limite de credito 
                        CORMDIBN.DefInstance.mnuEnvioLimCred.Enabled = true;
                        break;
                    case "EstructurasAltas":
                        CORVAR.OpcionesAcceso[0].sOpcion = "Estructuras";
                        CORVAR.OpcionesAcceso[0].bAltas = true;
                        break;
                    case "EstructurasBajas":
                        CORVAR.OpcionesAcceso[0].sOpcion = "Estructuras";
                        CORVAR.OpcionesAcceso[0].bBajas = true;
                        break;
                    case "EstructurasCambios":
                        CORVAR.OpcionesAcceso[0].sOpcion = "Estructuras";
                        CORVAR.OpcionesAcceso[0].bCambios = true;
                        break;
                    case "EstructurasConsultas":
                        CORVAR.OpcionesAcceso[0].sOpcion = "Estructuras";
                        CORVAR.OpcionesAcceso[0].bConsultas = true;
                        break;
                    ...
                    case "ReportesAltas":
                        ...
                        CORVAR.OpcionesAcceso[8].bAltas = true;
                        break;
                    case "ReportesBajas":
                        CORVAR.OpcionesAcceso[8].sOpcion = "Reportes";
                        CORVAR.OpcionesAcceso[8].bBajas = true;
                        break;
                    case "ReportesCambios":
                        CORVAR.OpcionesAcceso[8].sOpcion = "Reportes";
                        CORVAR.OpcionesAcceso[8].bCambios = true;
                        break;
                    case "ReportesConsultas":
                        CORVAR.OpcionesAcceso[8].sOpcion = "Reportes";
                        CORVAR.OpcionesAcceso[8].bConsultas = true;
                        break;
                    case "CategoriasAltas":
                        CORVAR.OpcionesAcceso[9].sOpcion = "Categorias";
                        CORVAR.OpcionesAcceso[9].bAltas = true;
                        break;
                    case "CategoriasBajas":
                        CORVAR.OpcionesAcceso[9].sOpcion = "Categorias";
                        CORVAR.OpcionesAcceso[9].bBajas = true;
                        break;
                    case "CategoriasCambios":
                        CORVAR.OpcionesAcceso[9].sOpcion = "Categorias";
                        CORVAR.OpcionesAcceso[9].bCambios = true;
                        break;
                    case "CategoriasConsultas":
                        CORVAR.OpcionesAcceso[9].sOpcion = "Categorias";
                        CORVAR.OpcionesAcceso[9].bConsultas = true;
                        break;
        ...
        //CORVAR.pszgblsql = CORVAR.pszgblsql + " and usu_tipo_prod = 'C'";
        //
        //if (CORPROC2.Obtiene_Registros() != 0)
        //{
        //CORVAR.igblRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion);
        ...
        //CORVAR.pszgblsql = CORVAR.pszgblsql + " and men_tipo_prod = 'C'";
        //
        //if (CORPROC2.Obtiene_Registros() != 0)
        //{
        //
        ...
        private void Habilita_Admin()
        {
            ...
            //1er. Menu
            //    CORMDIBN.IDM_ESP.Enabled = True
            //    CORMDIBN.IDM_PAR.Enabled = True
            //    CORMDIBN.IDM_INTD.Enabled = True
            //    CORMDIBN.IDM_CDF.Enabled = True
            //    CORMDIBN.IDM_ENV.Enabled = True
            //    CORMDIBN.IDM_CAMM.Enabled = True
            //    CORMDIBN.IDM_LIM.Enabled = True
            //    CORMDIBN.IDM_SEG.Enabled = True
            //    CORMDIBN.IDM_USU.Enabled = True
            //    CORMDIBN.IDM_GRU.Enabled = True
            //    CORMDIBN.IDM_BCO.Enabled = True
            //    CORMDIBN.IDM_SAL.Enabled = True
            //'
            //'    '2o. Menu
            //    CORMDIBN.IDM_OPE.Enabled = True
            //    CORMDIBN.IDM_TRR.Enabled = True
            //    CORMDIBN.IDM_DEP.Enabled = True
            //
            //'    '3er. Menu
            //    CORMDIBN.IDM_CAT.Enabled = True
            //    CORMDIBN.Estructuras_Gastos.Enabled = True
            //    CORMDIBN.IDM_COR.Enabled = True
            //    CORMDIBN.IDM_EMP.Enabled = True
            //    CORMDIBN.mnu_unidades.Enabled = True
            //    CORMDIBN.mnu_reportes.Enabled = True
            //    CORMDIBN.mnu_categorias.Enabled = True
            //    CORMDIBN.IDM_EJE.Enabled = True
            //    CORMDIBN.IDM_BAN.Enabled = True
            //    CORMDIBN.IDM_CCI.Enabled = True
            //    CORMDIBN.IDM_DIV.Enabled = True
            //    CORMDIBN.IDM_REG.Enabled = True
            //    CORMDIBN.mnuEnvioLimCred.Enabled = True
            //'
            //'    '4o. Menu
            //    CORMDIBN.IDM_CTA.Enabled = True
            //    CORMDIBN.IDM_CON.Enabled = True
            //    CORMDIBN.IDM_CEJ.Enabled = True
            //    CORMDIBN.IDM_CEM.Enabled = True
            //    CORMDIBN.IDM_ANA.Enabled = True
            //    CORMDIBN.IDM_DET.Enabled = True
            //    CORMDIBN.IDM_ATR.Enabled = True
            //    CORMDIBN.IDM_DEJ.Enabled = True
            //    CORMDIBN.IDM_AFI.Enabled = True
            //    CORMDIBN.IDM_GER.Enabled = True
            //    CORMDIBN.IDM_EER.Enabled = True
            //    CORMDIBN.mnu_envio_sbf.Enabled = True
            //    CORMDIBN.IDM_REN.Enabled = True
            //    If igblBanco = 80 Then
            //       CORMDIBN.IDM_BNX.Enabled = True
            //    Else
            //       CORMDIBN.IDM_BNX.Enabled = False
            //    End If
            //    CORMDIBN.IDM_GRA.Enabled = True
            //    CORMDIBN.IDM_GBIT.Enabled = True
            //    CORMDIBN.IDM_GCOR.Enabled = True
            //    CORMDIBN.IDM_GEMP.Enabled = True
            //    CORMDIBN.IDM_GACL.Enabled = True
            //    CORMDIBN.IDM_GSIT.Enabled = True
            //    CORMDIBN.IDM_GCRE.Enabled = True
            //    CORMDIBN.IDM_GANT.Enabled = True
            //    CORMDIBN.IDM_GVEN.Enabled = True
            //    CORMDIBN.IDM_GCOM.Enabled = True
            //    CORMDIBN.IDM_OPC.Enabled = True
            //
            //    '5o. menu
            //    CORMDIBN.IDM_ACL.Enabled = True
            //    CORMDIBN.IDM_CAP.Enabled = True
            //    CORMDIBN.IDM_HIS.Enabled = True
            //    CORMDIBN.IDM_AVE.Enabled = True
            //
            //Botones
            CORMDIBN.DefInstance.IDT_GPB[0].Enabled = true;
            CORMDIBN.DefInstance.IDT_GPB[1].Enabled = true;
        ...
        private void ID_ACC_ACE_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (mdlSeguridad.fncFirmaS041B(ref tempRefParam2, ID_ACC_CVE_EB.Text.Trim(), "",mdlSeguridad.enuTipoDlgSeguridad.tFirmaConModuloS041)) //se modifica para uso de TOKE
                {
                    ...
                    string tempRefParam = "";
                    mdlSeguridad.fncFirmaS041B(ref tempRefParam, "","", mdlSeguridad.enuTipoDlgSeguridad.tDesfirmaS041); //se modifica para uso de TOKEN
