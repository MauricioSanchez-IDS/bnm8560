        ...
        : System.Windows.Forms.Form
    {
        ...
        private void ID_MGR_IMP_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            try
            {
                ...
                PrinterHelper.Printer.Print("CREDITO TOTAL           : " + ID_MGR_CRE_TOT_CRR.CtlText);
                PrinterHelper.Printer.Print("CREDITO ACUMULADO       : " + ID_MGR_CRE_ACU_CRR.CtlText);
        ...
        private int Obtiene_DatosGrupo()
        {
            ...
            { //Exito
                if (VBSQL.SqlNextRow(CORVAR.hgblConexion) == VBSQL.MOREROWS)
                {
                    ...
                    ID_MGR_CIU_EB.Text = VBSQL.SqlData(CORVAR.hgblConexion, 7).Trim();
                    ID_MGR_POB_EB.Text = VBSQL.SqlData(CORVAR.hgblConexion, 8).Trim();
        ...
        private void Opera_Grupo()
        {
            ...
            try
            {
                ...
                int iCredTot = Convert.ToInt32(Conversion.Val(ID_MGR_CRE_TOT_CRR.defaultText));
                int iCredAcu = Convert.ToInt32(Conversion.Val(ID_MGR_CRE_ACU_CRR.CtlText));
                ...
                switch (Tag.ToString())
                {
                    ...
                    case CORCONST.TAG_CAMBIO:
                        ...
                        CORVAR.pszgblsql = CORVAR.pszgblsql + ",gpo_cred_tot = " + Conversion.Val(ID_MGR_CRE_TOT_CRR.CtlText).ToString();
                        CORVAR.pszgblsql = CORVAR.pszgblsql + ",gpo_acum_cred = " + Conversion.Val(ID_MGR_CRE_ACU_CRR.CtlText).ToString();
