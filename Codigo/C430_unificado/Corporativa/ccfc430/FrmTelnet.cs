...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        */
        ...
        private void SpdReportes_ButtonClicked(Object eventSender, AxFPSpread._DSpreadEvents_ButtonClickedEvent eventArgs)
        {
            ...
            try
            {
                if (eventArgs.col == COL_GENERAREPORTE)
                {
                    ...
                    ObjReporteProcesar.Col = eventArgs.col;
            ...
            try
            {
                ...
                if (VBSQL.OpenConn(10) == 0)
                {
                    ...
                    while (!rsReportes.EOF)
                    {
                        ...
                        SpdReportes.Col = 2;
                        SpdReportes.CellType = 10; //La columna acepta check box
                ...
                SpdReportes.CellType = 10; //La columna es de un grupo de check Box
                SpdReportes.TypeCheckCenter = true;
