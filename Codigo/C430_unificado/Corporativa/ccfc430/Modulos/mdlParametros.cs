...
namespace TCc430
{
	class mdlParametros
	{
        ...
        static public string sgDirAplicacion = string.Empty;
...
/* Se  comenta todo este código para incluir la lectura del Registry de Windows
			//Path Firmas
 ...
 */
            ...
            sgDirAplicacion = Path.GetDirectoryName(Application.ExecutablePath);
            ...
            //sgPathRepCorporativo = sgDirAplicacion.Trim() + "\\" + mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Rutas", "ReportesCorp").Trim();
