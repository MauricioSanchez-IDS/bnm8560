	...
	class CCFmodGeneral
	{
		...
		static public void  ReportCCF( AxMSComctlLib.AxListView plista,  string spFileName,  string spnameform)
		{
			...
			try
			{
                    ...
                    //ProcessStartInfo startInfo = new ProcessStartInfo("write.exe", slfile); //se modificó porque write.exe no soportó rutas c:\\program files\ corta en el espacio
					ProcessStartInfo startInfo = new ProcessStartInfo("notepad.exe", slfile);
...
//        static private frmLogin _frmLogin = null;

////        static public frmLogin ffrmLogin
//        {
//            get
//            {
//                if (_frmLogin == null)
