    ...
    internal class clsAltaEmpresa
    {
        ...
        public bool fncGrabaTablaRespB()
        {
            ...
            try
            {
                ...
                CORVAR.pszgblsql = " insert MTCINE01 (" + "\r\n";
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " emp_atn_a, " + "\r\n"; //char           'FSWB 20070222 NR Se incluyen campos Atencion A y Persona
                CORVAR.pszgblsql = CORVAR.pszgblsql + " emp_tipo_persona " + "\r\n"; //int      'FSWB NR 20070223
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " " + EmppszCartera + "    , " + "\r\n";
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " " + EmppszFecVenCred + " , " + "\r\n";
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " '" + EmpimAtencionA + "', " + "\r\n"; //FSWB 20070222 NR Se incluyen campos Atencion A y Persona
                CORVAR.pszgblsql = CORVAR.pszgblsql + " " + EmpimPersona.ToString() + " " + "\r\n"; //FSWB NR 20070223
                ...
                if (EmpbgblModFirma)
                {
                    ...
                    IMAGEN.GrabarImagen(CORREGFI.DefInstance.ID_FIR_FR1_IMM, "MTCINE01", "emp_fir_r1", " eje_prefijo = " + EmpimPrefijo.ToString() + " and gpo_banco = " + EmppszBanco.ToString() + " AND emp_num = " + lNumEmpresa.ToString().Trim());
                    IMAGEN.GrabarImagen(CORREGFI.DefInstance.ID_FIR_FR2_IMM, "MTCINE01", "emp_fir_r2", " eje_prefijo = " + EmpimPrefijo.ToString() + " and gpo_banco = " + EmppszBanco.ToString() + " AND emp_num = " + lNumEmpresa.ToString().Trim());
                    IMAGEN.GrabarImagen(CORREGFI.DefInstance.ID_FIR_FR3_IMM, "MTCINE01", "emp_fir_r3", " eje_prefijo = " + EmpimPrefijo.ToString() + " and gpo_banco = " + EmppszBanco.ToString() + " AND emp_num = " + lNumEmpresa.ToString().Trim());
                }
                Cursor.Current = Cursors.Default;
            }
            catch
        ...
        public bool fncActualizaConsecutivoB()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("No se pudo modificar el consecutivo de las empresas ", "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    result = false;
                    Cursor.Current = Cursors.Default;
                    return result;
                }
        ...
        public bool fncActualizaEstatusTemporalB(int ipEstatus)
        {
            ...
            try
            {
                CORVAR.pszgblsql = " UPDATE MTCINE01 set ";
        ...
        public string fncConsultaS111SComDrv(string slCuenta, out string slConsulta)
        {
            ...
            {
                MdlCambioMasivo.MsgInfo("generando el dialogo");
            }
            ...
            if (mdlParametros.ES_DEBUG)
            {
                MdlCambioMasivo.MsgInfo("Dialogo a enviar: " + slDialogo);
            }
        ...
        public bool fncInsertaM111BEMP()
        {
            ...
            try
            {
                ...
                CORVAR.pszgblsql = " exec InsertaM111BEMP " + EmpimPrefijo.ToString() + "," + EmppszBanco + "," + lNumEmpresa.ToString().Trim();
        ...
        public bool fncInsertaM111BEJE0()
        {
            ...
            try
            {
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + ", '137' "; //& Trim(pszSucursal) & "'" ' char
                CORVAR.pszgblsql = CORVAR.pszgblsql + ", '137' "; //& Trim(pszSucursal) & "'" ' char
        ...
        public bool fncEliminaRespB()
        {
            ...
            try
            {
                CORVAR.pszgblsql = " DELETE FROM MTCINE01 ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHERE eje_prefijo = " + EmpimPrefijo.ToString() +
                                   " and gpo_banco = " + EmpimBanco.ToString() + " AND emp_num = " + lNumEmpresa.ToString();
