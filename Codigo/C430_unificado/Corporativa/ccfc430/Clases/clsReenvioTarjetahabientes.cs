...
namespace TCc430
{
	internal class clsReenvioTarjetahabientes
	{
        ...
        const string smArchivoLog = "c:\\usuarios\\fg11306\\";
		private void  prEstado0()
		{
			try
			{
					...
					if (gObjetoAlta.fncObtenNumB())
					{
						...
						{
							MdlCambioMasivo.MsgInfo("Valor Obtenido:  desde gObjetoAlta.fncEnviaDialogoLocalPrimeraS Slresultado: " + slResultado + "\r" + 
							                        "Valor Obtenido:  slRespuesta:" + slRespuesta);
						}
						if (slResultado == "00")
						{
