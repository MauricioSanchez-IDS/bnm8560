...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void BtnProceso_ClickEvent(Object eventSender)
        {
            ...
            try
            {
                if (Index == 0)
                {
                    ...
                    if (OptTipoCambio[0].Checked)
                    {
                        ...
                        {
                            string tempRefParam = "Tarjeta Corporativa.- Cambios  Masivos";
                    ...
                    else if (OptTipoCambio[1].Checked)
                    {
                        ...
                        {
                            string tempRefParam2 = "Tarjeta Corporativa.- Cambios  Masivos";
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(BtnProceso_ClickEvent)", e);
            }
        }
        ...
        private void CboValorModificar_SelectedIndexChanged(Object eventSender, EventArgs eventArgs)
        {
            ...
            if (CboValorModificar.SelectedIndex > -1)
            {
                ...
                if (Item == clsDialogo.enuTipoDialogo.tCambioDispEjecutivoS111)
                {
                ...
                else if (Item == clsDialogo.enuTipoDialogo.tCambioGenPinPlaEjecutivoS111 || Item == clsDialogo.enuTipoDialogo.tCambioTipoBloqueoEjecutivoS111)
                {
        ...
        private bool FnEfectuarCambioMasivo(string intTipoProceso)
        {
                ...
                if (VBSQL.OpenConn(10) == 0)
                {
                    ...
                    if (!RsEmpresa.EOF)
                    {
                        ...
                        do
                        {
                            ...
                            {
                                if (objCambioMasivo.get_IdTransaccion(objCambioMasivo.indice) == clsDialogo.enuTipoDialogo.tCambioGenPinPlaEjecutivoS111 || objCambioMasivo.get_IdTransaccion(objCambioMasivo.indice) == clsDialogo.enuTipoDialogo.tCambioDispEjecutivoS111 || objCambioMasivo.get_IdTransaccion(objCambioMasivo.indice) == clsDialogo.enuTipoDialogo.tCambioTipoBloqueoEjecutivoS111 || objCambioMasivo.get_IdTransaccion(objCambioMasivo.indice) == clsDialogo.enuTipoDialogo.tCambioMCCEjecutivoS111)
                                {
                ...
                if (strNombreArchivo != "*.xmt" && strNombreArchivo != "")
                {
                    ...
                    if (!FileSystem.EOF(intFreeFileCM))
                    {
                        ...
                        do
                        {
                            ...
                            if (strLineaArchivo.Length != (9 + Formato.igLongitudEmpresa + Formato.igLongitudEjecutivo + objCambioMasivo.ValorMaximo.ToString().Length))
                            {
            ...
            {
                string tempRefParam3 = "Tarjeta Corporativa (Cambios Masivos)";
                if (MdlCambioMasivo.FnMsgYesno("¿ Desea ver el resultado de los registros rechazados ? ", ref tempRefParam3))
                {
                    ...
                    FrmError.Text = "Tarjeta Coporativa.-Cambios Masivos Pendientes de Procesar";
                    FrmError.ShowDialog();
                    FrmError.Close();
                    FrmError = null;
        ...
        //throw new Exception("Migration Exception: 'Resume' not supported");
        Handler:
            string tempRefParam4 = "Tarjeta Corporativa.- FnEfectuarCambioMasivo";
        ...
        private bool FnActualizaEjecutivo(int intPrefijo, int intEjecutivo, int intGpoBanco)
        {
            ...
            try
            {
                ...
                if (VBSQL.OpenConn(9) == 0)
                {
                    ...
                    strSql = strSql + objCambioMasivo.ValorModificar.ToString();
                    strSql = strSql + " Where emp_num= " + objCambioMasivo.NoEmpresa.ToString();
