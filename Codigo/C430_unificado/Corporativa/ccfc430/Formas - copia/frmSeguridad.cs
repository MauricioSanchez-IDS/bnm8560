			...
			private void  cmdSeguridad_Click( Object eventSender,  EventArgs eventArgs)
			{
					...
					switch(Index)
					{
						case 0 :  //Aceptar 
							...
							string tempRefParam = ""; 
							mdlSeguridad.fncFirmaS041B(ref tempRefParam, "", "",mdlSeguridad.enuTipoDlgSeguridad.tDesfirmaS041); //se agrega TOKEN en el tercer parámetro
							 
							string tempRefParam2 = txtSeguridad[0].Text.Trim(); 
							if (mdlSeguridad.fncFirmaS041B(ref tempRefParam2, txtSeguridad[1].Text.Trim(), "", mdlSeguridad.enuTipoDlgSeguridad.tFirmaSinModuloS041)) //se agrega tercer parámetro para TOKEN
							{
