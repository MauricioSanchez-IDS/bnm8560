...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void prcEnviaDialogo(ref  string slDialogo, ref  string pszRegresaS111, ref  bool EnviaCambioS111, N_ActualizaS111.ClsConectaS111 ObjConexionS111)
        {
            ...
            enEstadoTransaccion = (TransS111.EnumRespTransaccion)ObjConexionS111.FnEnviarTransaccion(tempString, tempString, tempString);
            enEstadoTransaccion = TransS111.EnumRespTransaccion.EnRespDesconocida;

            //== TransS111.EnumRespTransaccion.EnRespDesconocida; //Solo es verdaderá la transaccion cuando no contesta una situacion de error como operacion negada, etc.


            bool tempRefParam = true;
            pszRegresaS111 = ObjConexionS111.GetMsgerror(); //Lee el mensaje que llega del s111
