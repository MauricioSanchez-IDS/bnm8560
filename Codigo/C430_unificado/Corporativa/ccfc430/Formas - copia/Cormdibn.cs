...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void Get_Help(byte HelpTopic)
        {
            ...
            {
                MessageBox.Show("No se puede hallar el archivo de Ayuda Tarjeta Corporativa.HLP.Compruebe si existe en su disco; de lo contrario necesitará instalarlo de nuevo.", "Ayuda de Windows", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        public void IDM_BAS_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                MessageBox.Show("No se puede hallar el archivo Tarjeta Corporativa.hlp. ¿Desea intentar hallarlo usted mismo?", "Ayuda de Windows", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
            this.Cursor = Cursors.Default;
        ...
        public void IDM_BNX_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            if (CORCTBNX.DefInstance.flag)
                CORCTBNX.DefInstance.Close(); ya no se utiliza esta opción 21/10/09  */
        ...
        public void Guarda_Formato()
        {
            ...
            try
            {
                ...
                //ros      CORMDIBN!ID_COR_CMD.Action = (FPSpreadADO.ActionConstants)DLG_FILE_SAVE
                ...
                //ros      CORMDIBN!ID_COR_CMD.Action = (FPSpreadADO.ActionConstants)NONE
                ...
                switch (CORVAR.igblFormaActiva)
                {
                    case CORCONST.INT_ACT_CEJ:
                        Obten_Formatos("FormatoConcentradoEmpresa", CORRPCEJ.DefInstance.ID_CEJ_REP_SS);
                        Guarda_Fmt(CORRPCEJ.DefInstance.ID_CEJ_REP_SS);
                        break;
                    case CORCONST.INT_ACT_CGR:
                        Obten_Formatos("FormatoConcentradoGrupo", CORRPCGR.DefInstance.ID_CGR_REP_SS);
                        Guarda_Fmt(CORRPCGR.DefInstance.ID_CGR_REP_SS);
                        break;
                    case CORCONST.INT_ACT_ANG:
                        Obten_Formatos("FormatoConsumosPorGiro", CORRPANG.DefInstance.ID_GIR_CON_SS);
                        Guarda_Fmt(CORRPANG.DefInstance.ID_GIR_CON_SS);
                        break;
                    case CORCONST.INT_ACT_DAT:
                        Obten_Formatos("FormatoDetalleAtrasos", CORRPDAT.DefInstance.ID_CEJ_REP_SS);
                        Guarda_Fmt(CORRPDAT.DefInstance.ID_CEJ_REP_SS);
                        break;
                    case CORCONST.INT_ACT_DEJ:
                        Obten_Formatos("FormatoDetalleEjecutivos", CORRPDEJ.DefInstance.ID_CEJ_REP_SS);
                        Guarda_Fmt(CORRPDEJ.DefInstance.ID_CEJ_REP_SS);
                        break;
                    case CORCONST.INT_ACT_EMA:
                        Obten_Formatos("FormatoEmpresasAfiliadas", CORRPEM2.DefInstance.ID_EMA_REP_SS);
            ...
            {
                CRSGeneral.prObtenError("frmSBFEmpresa (Guarda_Formato)", exc);    
        ...
        private void Form_Load()
        {
            ...
            //Se modifica el siguiente código para leer los parámetros del Registry de Windows
            ...
            //ModoRefrSAPUF = 0
            //TimerSAPUF = 9999
            //INICIA BLOQUE PARA OBTENER password a través de SAPUF
            /* se modificó el siguiente código para leer valores del Registry de Windows
            ...
            int resultado = SapufEnlace.Solicitar_Password(cve_operacion, MaqDestinoSAPUF, UsuDestinoSAPUF, TipoDestSAPUF, AplDestinoSAPUF, AplOrigenSAPUF, ModoRefrSAPUF.ToString(), TimerSAPUF.ToString());
            if (resultado == 0)
            {
                //AIS-1182 NGONZALEZ
                ...
                if (sError.ToString() == "0000" && sSubError.ToString() == "0000")
                {
                    ...
                    //se modifica este parametro para leer del Registry de Windows
                    ...
                    if (CORDBLIB.Conexion_Servidor() == VBSQL.FAIL)
                    {
                        ...
                        resultado = SapufEnlace.Solicitar_Password(cve_operacion, MaqDestinoSAPUF, UsuDestinoSAPUF, TipoDestSAPUF, AplDestinoSAPUF, AplOrigenSAPUF, ModoRefrSAPUF.ToString(), TimerSAPUF.ToString());
                        if (resultado == 0)
                        {
                            //AIS-1182 NGONZALEZ
                            //tam = API.Encryption.Recuperar_msg(s, sError, sSubError);
        ...
        private void CORMDIBN_Closing(Object eventSender, CancelEventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError("frmSBFEmpresa (CORMDIBN_Closing)", e);
                //throw new Exception("Migration Exception: The following exception could be handled in a different way after the conversion: ");
            }
        }
        ...
        public void mnuCnsDtlEmpresas_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            try
            {
                ...
                if (VBSQL.OpenConn(10) == 0)
                {
                    ...
                    CORVAR.pszgblsql = "SELECT e.emp_num, e.emp_nom, e.emp_fec_venc_cred, e.emp_cred_tot, emp_acum_cred = ";
                    ...
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and a.emp_num = e.emp_num ";
                    ...
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and c.emp_num = e.emp_num ";
                    ...
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " case when e.emp_sector=1 then '01 Industrial/Procesadoras' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=2 then '02 Distribuidores/Comercializadores' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=3 then '03 Otros Servicios' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=4 then '04 Servicios Financieros' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=5 then '05 Sector Publico' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=6 then '06 Gobierno Federal' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=7 then '07 Gobierno Estatal y Municipal' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=8 then '08 Otros' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=9 then '09 Abarroteros/Perecederos' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=10 then '10 Hoteles/Hoteles Boutique, Moteles' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=11 then '11 Restaurantes/Cafeterias' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=12 then '12 Transporte/Fletes' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=13 then '13 Oficinas Corporativas' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=14 then '14 Automotrices/Agencias/Talleres' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=15 then '15 Tiendas de Autoservicio' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=16 then '16 Farmacias/Boticas' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=17 then '17 Comedores industriales/procesadores de alimentos' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=18 then '18 Vinaterias/Licorerias' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=19 then '19 Consultores/Despachos' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_sector=20 then '20 Medios de comunicacion/Agencias de Publicidad' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " else 'Sin clasificacion' end empresa_sector, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.ejx_numero, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " g.ejx_nombre, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_cta_contable, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_num_cartera, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_plazo_gracia, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_princ_acc, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_tipo_fac, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_tipo_pago, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_telefono, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_extension, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_tel_lada, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_fax, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_fax_lada, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_calle, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_col, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_ciu, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_pob, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_edo, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_envio_cp, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " case when f.ths_situacion_cta=' ' then 'NORMAL' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='C' then 'CANCEL CS' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='E' then 'CANCEL SS' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='O' then 'SOBREGIRO' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='P' then 'PROB COBRO' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='D' then 'ATRASADA' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when f.ths_situacion_cta='0' then 'CERO' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " else 'SIN ESTATUS' end situacion_cta, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " h.cliente_num, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_nom_r1, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_nom_r2, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_nom_r3, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_email, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " e.emp_rfc, ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " case when e.emp_tipo_persona=1 then 'Persona Moral' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_tipo_persona=2 then  'Persona Fisica' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " when e.emp_tipo_persona=3 then  'Fisica con Actividad Empresarial' ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " else 'Sin clasificacion' end tipo_persona ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " from MTCEMP01 e,  MTCTHS01 f, MTCEJX01 g, MTCCLI01 h ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " WHERE e.eje_prefijo=" + CORVAR.igblPref.ToString() + " AND e.gpo_banco=" + CORVAR.igblBanco.ToString() + " ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.eje_prefijo*=h.eje_prefijo ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.gpo_banco*=h.gpo_banco ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.emp_num*=h.emp_num ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.eje_prefijo*=f.eje_prefijo ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.gpo_banco*=f.gpo_banco ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.emp_num*=f.emp_num ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and f.eje_num=0 ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " and e.ejx_numero*=g.ejx_numero ";
                    CORVAR.pszgblsql = CORVAR.pszgblsql + " ORDER BY e.emp_num ";
                    ...
                    if (!adorst.BOF && !adorst.EOF)
                    {
                        ...
                        strfile = mdlParametros.sgPathRepEmpresas + "\\" + "RepEmpNvas" + DateTime.Today.ToString("yyyyMMdd") + ".txt";
                        ...
                        StrCadena.Append("  Crédito Acumulado  Día Corte ");
                        StrCadena.Append("Sector                                              ");
                        StrCadena.Append("Ejecutivo    ");
                        StrCadena.Append("Nombre Ejecutiva Banamex                      ");
                        StrCadena.Append("Cuenta Contable            ");
                        StrCadena.Append("Numero de Cartera ");
                        StrCadena.Append("Plazo gracia  ");
                        StrCadena.Append("Principal Accionista                 ");
                        StrCadena.Append("Tipo Facturación ");
                        StrCadena.Append("Tipo de Pago ");
                        StrCadena.Append("Teléfono             ");
                        StrCadena.Append("Extensión  ");
                        StrCadena.Append("Lada       ");
                        StrCadena.Append("Fax                  ");
                        StrCadena.Append("Lada Fax   ");
                        StrCadena.Append("Domicilio envío Calle y numero      ");
                        StrCadena.Append("Colonia                   ");
                        StrCadena.Append("Ciudad                    ");
                        StrCadena.Append("Población                 ");
                        StrCadena.Append("Edo  ");
                        StrCadena.Append("C.P.       ");
                        StrCadena.Append("Situación cta ");
                        StrCadena.Append("Num Cliente  ");
                        StrCadena.Append("Nombre representante 1              ");
                        StrCadena.Append("Nombre representante 2              ");
                        StrCadena.Append("Nombre representante 3              ");
                        StrCadena.Append("Mail                                               ");
                        StrCadena.Append("RFC           ");
                        StrCadena.Append("Tipo Persona                     ");
                        ...
                        while (!adorst.EOF)
                        {
                            ...
                            int tempRefParam13 = 52;
                            string tempRefParam14 = " ";
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["empresa_sector"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 13;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["ejx_numero"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 46;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["ejx_nombre"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 27;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_cta_contable"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 18;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_num_cartera"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 14;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_plazo_gracia"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 37;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_princ_acc"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 17;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_tipo_fac"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 13;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_tipo_pago"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 21;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_telefono"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 11;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_extension"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 11;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_tel_lada"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 21;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_fax"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 11;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_fax_lada"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 36;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_calle"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 26;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_col"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 26;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_ciu"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 26;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_pob"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 5;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_edo"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 11;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_envio_cp"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 14;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["situacion_cta"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 13;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["cliente_num"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 36;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_nom_r1"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 36;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_nom_r2"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 36;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_nom_r3"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 51;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_email"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 14;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["emp_rfc"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
                            tempRefParam13 = 33;
                            StrCadena.Append(CRSGeneral.sfncJustificar(Convert.ToString(adorst.Fields["tipo_persona"].Value).Trim(), CRSGeneral.cteJustificado.cteIzquierda, ref tempRefParam13, ref tempRefParam14));
            ...
            catch
            {
                ...
                string tempRefParam13 = "Tarjeta Corporativa.- cmdReporte_Click";
        ...
        public void mnuEnvioLimCred_Click(Object eventSender, EventArgs eventArgs)
        {
        ...
        private int fncCuentaBancosI()
        {
            ...
            {
                CRSGeneral.prObtenError("frmSBFEmpresa (fncCuentaBancosI)", exc);
        ...
        private void ID_COR_BHER_Enter(object sender, EventArgs e)
        {

        }

        private void IDM_ALTAS_MASIVAS_Click(object sender, EventArgs e)
        {
