...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
                ...
                if (iRegs != CORVB.NULL_INTEGER)
                {
                    ...
                    while (VBSQL.SqlNextRow(CORVAR.hgblConexion) != VBSQL.NOMOREROWS)
                    {
                        ...
                        if (dTotal != CORVB.NULL_INTEGER)
                        {
                            ...
                            ID_GIR_CON_SS.Col = 2;
                            ID_GIR_CON_SS.CellType = new FarPoint.Win.Spread.CellType.EditBaseCellType();
        ...
        private void Formatea_SS()
        {
            ...
            ID_GIR_CON_SS.set_ColWidth(1, 48 * 8);
            ID_GIR_CON_SS.set_ColWidth(2, 18 * 9);
        ...
        private void ID_GIR_IMP_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_GIR_IMP_PB_Click)", e);
            }
