		...
		private void  prModulosFormas()
		{
            ...
            if (sFacultad != "")
            {
                ...
                if (Convert.ToInt32(_slNivel) == Convert.ToInt32(slNivel)) // NIVEL 10
                {
                    ...
                    prModulosFormasDet("CORMDIBN", "IDM_CON", slModulo, slNivel, ref typmModulosFormas);
            ...
            if (sFacultad != "")
            {
                ...
                if (Convert.ToInt32(_slNivel) == Convert.ToInt32(slNivel)) // NIVEL 10 
                {
                    ...
                    prModulosFormasDet("CORMNPAR", "ID_PAR_CAN_PB", slModulo, slNivel, ref typmModulosFormas); //'22 consulta de productos
                    //prModulosFormasDet "CORMNPAR", "ID_PAR_ACE_PB", slModulo, slNivel, typmModulosFormas //22i consulta de productos
                ...
                if (Convert.ToInt32(_slNivel) == Convert.ToInt32(slNivel))  // NIVEL 20
                {
                    ...
                    //prModulosFormasDet "frmEnvioLimCred", "cmdEnviaCred", slModulo, slNivel, typmModulosFormas //'33 envio de cambios pendientes
                    ...
                    prModulosFormasDet("CORMNPAR", "ID_PAR_ACE_PB", slModulo, slNivel, ref typmModulosFormas); //'43 modifica producto no tiene boton de bajas
