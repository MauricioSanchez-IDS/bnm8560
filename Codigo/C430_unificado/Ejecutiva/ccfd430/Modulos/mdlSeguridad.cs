            ...
            try
            {
                ...
                switch (ipTipoFirma)
                {
                    case enuTipoDlgSeguridad.tFirmaConModuloS041:  //***** Aqui se va a firmar para obtener los modulos 
                        ...
                        {
                            MessageBox.Show(Strings.Mid(slRespuesta, (slRespuesta.IndexOf("SEG;") + 1) + 4, 80).Trim(), "Tarjeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            sgDlgSeguridad = "";
                            return false;
                        }
                        ...
                        {
                            MessageBox.Show("Favor de reintentar su firma debido a una falla en la conexión.", "Tarjeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            sgDlgSeguridad = "";
                            return false;
                        }
                        if (mdlParametros.ES_DEBUG)
                    ...
                    case enuTipoDlgSeguridad.tFirmaSinModuloS041:  //Aqui se va a firmar sin obtener los modulos 
                        ...
                        if (slRespuesta.Length + 1 < ilPosicionInicial + 24)
                        {
                            MessageBox.Show("Favor de reintentar su firma debido a una falla en la conexión.", "Tarjeta Ejectiva", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            sgDlgSeguridad = "";
                            return false;
                        }
                        ...
                        {
                            MessageBox.Show(Strings.Mid(slRespuesta, 40, 80).Trim(), "Tajeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            result = false;
                        }
                        break;
