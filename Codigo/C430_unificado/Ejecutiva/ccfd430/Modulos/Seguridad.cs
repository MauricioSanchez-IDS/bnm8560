...
namespace TCd430
{
	class Seguridad
	{
		...
		static public void  Deshabilita_Menu()
		{
            ...
            CORMDIBN.DefInstance.mnuArcRevisionCanc.Enabled = false; //Revisión de Cancelaciones
            CORMDIBN.DefInstance.mnuEnvioTope.Enabled = false; //Autorización de Límites de Uso
            CORMDIBN.DefInstance.mnuCamMasivos.Enabled = false; //Cambios Masivos de Ejecutivo
            CORMDIBN.DefInstance.mnuArchAutCancelaciones.Enabled = false; //Autorización de Cancelaciones
            CORMDIBN.DefInstance.mnuAutAltasMasivas.Enabled = false; //Autorización de Altas
