...
namespace TCd430
{
	class MdlCambioMasivo
	{
        ...
        //'modificación para cambio de dirección
        public const string TRANS_CAMBIO_DIR = "A";
        public const string TRANS_LIM_USO = "L";
        public const int MIN_LIM_USO = 100;
        public const int MAX_LIM_USO = 999999;
