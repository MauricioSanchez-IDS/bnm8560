...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void ID_FIR_ACE_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            //Yuria 19/05/09 modifica el nombre de firma.pcx a firmaa.pcx, ver forma en la forma CORALTFI.CS en la función ID_FIR_GUA_PB_Click
            //if (FileSystem.Dir(CORVAR.pszgblPathFirmas + "firma.pcx", FileAttribute.Normal) != CORVB.NULL_STRING)
            try
            {
                if (FileSystem.Dir(CORVAR.pszgblPathFirmas + "firmaa.pcx", FileAttribute.Normal) != CORVB.NULL_STRING)
                {
                    //lArchiLong = (int)(new FileInfo(CORVAR.pszgblPathFirmas + "firma.pcx")).Length;
                    lArchiLong = (int)(new FileInfo(CORVAR.pszgblPathFirmas + "firmaa.pcx")).Length;
                    ...
                    else
                    {
                        ...
                        IMAGEN.nomArchivo = CORVAR.pszgblPathFirmas + "firmaa.pcx";
        ...
        private void ID_FIR_GUA_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            //ID_FIR_OK_IMM.SaveImage = CORVAR.pszgblPathFirmas + "firma.pcx"; comenta yuria 19/05/09
            //Yuria 19/05/09
            //se actualizó el nombre del archivo de la firma, ya que la función que GrabarFirma es comun para
            //las firmas de los representantes de las empresas, que toman el último caracter del nombre del campo de firma:
            // emp_fir_r1, emp_fir_r2, emp_fir_r3
            //y se lo pegan al nombre firma?.pcx
            //en este caso para el campo ejx_firma, el último caracter es a, por lo que sería firmaa.pcx
