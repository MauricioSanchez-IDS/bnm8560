...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        FarPoint.Win.Spread.CellType.EditBaseCellType CorpcejCell = new FarPoint.Win.Spread.CellType.EditBaseCellType();
        ...
        private void Calcula_totales(double iMaxRenglones)
        {
            ...
            //Totales
            ID_CEJ_REP_SS.Col = 2;
            ID_CEJ_REP_SS.CellType = CorpcejCell;
            ...
            //Saldo Anterior
            //ID_CEJ_REP_SS.Col = 4;
            //ID_CEJ_REP_SS.CellType = (FPSpreadADO.CellTypeConstants)1;
        ...
        private void Carga_Encabezado()
        {
            ...
            CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_tipo_pago,emp_sucur,emp_acum_cred, convert(varchar(10),emp_fec_venc_cred,103) ";
            ...
            if (CORPROC2.ObtieneRegistros(ref CORVAR.pszgblsql) != 0)
            {
                do
                {
                    while (VBSQL.SqlNextRow(CORVAR.hgblConexion) != VBSQL.NOMOREROWS)
                    {
                        ...
                        dSaldoNuevo = dSaldoAnterior + dCompras + dDispEfec + dComisiones - dIntereses - dPagosAbonos;
                ...
                for (int iCont = 1; iCont <= ID_CEJ_REP_SS.MaxRows; iCont++)
                {
                    ID_CEJ_REP_SS.Row = iCont;
                    ID_CEJ_REP_SS.Col = 12;
                    if (Double.Parse(CORRPCEJ.DefInstance.ID_CEJ_REP_SS.ToString()) > CORVB.NULL_INTEGER)
                    {
                        ...
                        if (slTipoFacturacion == "C")
                        {
                            ...
                            if (Double.TryParse(ID_CEJ_REP_SS.ToString(), NumberStyles.Number, CultureInfo.CurrentCulture.NumberFormat, out dbNumericTemp) && Double.Parse(ID_CEJ_REP_SS.ToString()) == 0)
                            {
                                ID_CEJ_REP_SS.Col = 12;
                                dSumaSaldos += Double.Parse(CORRPCEJ.DefInstance.ID_CEJ_REP_SS.ToString());
                                dSumSalDeud += Double.Parse(CORRPCEJ.DefInstance.ID_CEJ_REP_SS.ToString());
                            }
                        }
                        else
                        {
                            ID_CEJ_REP_SS.Col = 12;
                            dSumaSaldos += Double.Parse(ID_CEJ_REP_SS.ToString());
                            dSumSalDeud += Double.Parse(ID_CEJ_REP_SS.ToString());
                        }
                    }
                    else
                    {
                        ...
                        if (slTipoFacturacion == "C")
                        {
                            ...
                            if (Double.TryParse(ID_CEJ_REP_SS.ToString(), NumberStyles.Number, CultureInfo.CurrentCulture.NumberFormat, out dbNumericTemp2) && Double.Parse(ID_CEJ_REP_SS.ToString()) == 0)
                            {
                                ID_CEJ_REP_SS.Col = 12;
                                dSumSalAcre += Double.Parse(CORRPCEJ.DefInstance.ID_CEJ_REP_SS.ToString());
                            }
                        }
                        else
                        {
        ...
        private void Formatea_Spread()
        {
            ...
            ID_CEJ_REP_SS.Col = 1;
            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.set_ColWidth(1, 6 * 4);
            ID_CEJ_REP_SS.Text = "Cuenta";

            ID_CEJ_REP_SS.Col = 2;
            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.set_ColWidth(2, 25 * 4);
            ID_CEJ_REP_SS.Text = "Ejecutivo";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 3;
            ID_CEJ_REP_SS.set_ColWidth(3, 10 * 4);
            ...
            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 4;
            ID_CEJ_REP_SS.set_ColWidth(4, 10 * 4);
            ID_CEJ_REP_SS.Text = "C. de Costos";

            //ID_CEJ_REP_SS.Row = 0;
            //ID_CEJ_REP_SS.Col = 6;
            //ID_CEJ_REP_SS.set_ColWidth(6, 10);
            //ID_CEJ_REP_SS.Text = "Atrasos";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 5;
            ID_CEJ_REP_SS.set_ColWidth(5, 15 * 4);
            ID_CEJ_REP_SS.Text = "Saldo Anterior";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 6;
            ID_CEJ_REP_SS.set_ColWidth(6, 10 * 4);
            ID_CEJ_REP_SS.Text = "Consumos";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 7;
            ID_CEJ_REP_SS.set_ColWidth(7, 10 * 4);
            ID_CEJ_REP_SS.Text = "Disp. Efvo.";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 8;
            ID_CEJ_REP_SS.set_ColWidth(8, 10 * 4);
            ID_CEJ_REP_SS.Text = "Pagos";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 9;
            ID_CEJ_REP_SS.set_ColWidth(9, 10 * 4);
            ID_CEJ_REP_SS.Text = "Comisiones";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 10;
            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.set_ColWidth(10, 10 * 4);
            ID_CEJ_REP_SS.Text = "Rendimientos";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 11;
            ID_CEJ_REP_SS.set_ColWidth(11, 10 * 4);
            ID_CEJ_REP_SS.Text = "I.V.A.";

            ID_CEJ_REP_SS.Row = 0;
            ID_CEJ_REP_SS.Col = 12;
            ID_CEJ_REP_SS.set_ColWidth(12, 15 * 4);
        ...
        private void Llena_Detalle(double iRenglon)
        {
            ...
            //*: Cambio de tipo de la variable para permitir la generación de reporte
            //*: EISSA MRG 2005-03-28
            //ID_CEJ_REP_SS.Text = sEjeNumNom; 
            ID_CEJ_REP_SS.Text = Strings.Format(sEjeNumNom, "00000000");
            //*: Fin: Cambio de tipo de la variable para permitir la generación de reporte
            //*: ****************************************************************************
            ...
            if (slTipoFacturacion == "C")
            {
                if (llEjecutivo == 0)
                {
                    dTotComisiones = dTotComisiones + dComisiones - dIva;
                }
            }
            else
            {
