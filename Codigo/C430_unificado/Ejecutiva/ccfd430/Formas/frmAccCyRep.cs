                    ...
                    if (ID_CEM_EMP_LB.GetItemChecked(licont))
                    {
                        ...
                        if (chkNivel[0].CheckState == CheckState.Checked)
                        {
                            if (unilPadre.ResumenRUN.TotalesTH.Count == 0)
                            {
                                ...
                                string tempRefParam9 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
                            ...
                            else if (unilPadre.ResumenRUN.TotalesTH.Count > 0)
                            {
                                ...
                                string tempRefParam12 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
                        ...
                        if (chkNivel[1].CheckState == CheckState.Checked)
                        {
                            if (unilPadre.ResumenRUN.TotalesTH.Count == 0)
                            {
                                ...
                                string tempRefParam15 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
                            ...
                            else if (unilPadre.ResumenRUN.TotalesTH.Count > 0)
                            {
                                ...
                                string tempRefParam18 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
                        ...
                        if (chkNivel[2].CheckState == CheckState.Checked)
                        {
                            if (unilPadre.ResumenRUN.TotalesTH.Count == 0)
                            {
                                ...
                                string tempRefParam21 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
                            ...
                            else if (unilPadre.ResumenRUN.TotalesTH.Count > 0)
                            {
                                ...
                                string tempRefParam24 = slPath + "\\" + CORVAR.igblPref.ToString() + "_" + CORVAR.igblBanco.ToString() + "_" + llEmpresa.ToString() + "\\";
