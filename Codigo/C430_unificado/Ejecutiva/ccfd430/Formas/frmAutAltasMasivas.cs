...
namespace TCd430
{
	internal partial class frmAutAltasMasivas
		: System.Windows.Forms.Form
		{
            ...
            private N_ActualizaS111.ClsConectaS111 conS111;
            ...
            {	        
                ...
                //'    conS111.FnDesconectarS111
                    ...
                    mdlAltasMasivas.slCuentasAutorizar = ArraysHelper.RedimPreserve<string[]>(mdlAltasMasivas.slCuentasAutorizar, new int[] { 1 });
                    ...
                    if (respuesta)
                    {
                         ...
                         for (i = 0; i <= mdlAltasMasivas.slCuentasAutorizar.GetUpperBound(0); i++)
                         {
                             ...
                             if (mdlAltasMasivas.slCuentasAutorizar[i] != "")
                             {
                                 ...
                                 eje_rfc = smdatosCuenta[3];
                             
                                if (Seguridad.usugUsuario.NominaS == Conversion.Str(smdatosCuenta[6]).Trim())
                                {
                                    txtLog.Text = txtLog.Text + "El Checker no puede ser igual a Maker al declinar la cuenta del tarjetahabiente: " + smdatosCuenta[4] + " de la empresa: " + smdatosCuenta[5] + "\r\n";
                                }
                                else
                                {
                                    ...
                                    {   
                                        txtLog.Text = txtLog.Text + "Se declino la cuenta del tarjetahabiente: " + smdatosCuenta[4] + " de la empresa: " + smdatosCuenta[5] + "\r\n";
                                    }
                                    else
                                    {
