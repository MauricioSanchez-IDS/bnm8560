...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        string pszEstatusEmp = String.Empty;

        private clsSucursal ObjSucursalPromotora;
        private Collection ColSucursalPromotora;
        ...
        */
        ...
        private bool fncValidaNumEmpresa(int lpNumEmp)
        {
            ...
            {
                CRSGeneral.prObtenError ("CORMNEMP - fncValidaNumEmpresa",e);
                return false;
            }
        }

        private clsSucursal AsignaSucursal(string strItem, int iIndex)
        {
            try
            {
                clsSucursal mObjSucursal;
                if (ColSucursalPromotora.Contains(strItem))
                {
                    mObjSucursal = (clsSucursal)ColSucursalPromotora[iIndex+1];
                    return mObjSucursal;
                }
                else
                {
            ...
            {
                throw new Exception("AsignaSucursal: " + exc.Message);
            }
        ...
        private void Agrega_Item()
        {
            ...
            {
                throw new Exception("Agrega_Item: " + exc.Message);
            }
        }
        ...
        private void Busca_Ejecutivo()
        {
            ...
            {
                throw new Exception("Busca_Ejecutivo: " + exc.Message);
            }
        ...
        private int Busca_EnCombo(string pszNomina)
        {
            ...
            {
                throw new Exception("Busca_EnCombo: " + exc.Message);
            }
        ...
        private bool ComparaDatosCambio()
        {
            ...
            {
                throw new Exception("ComparaDatosCambio: " + exc.Message);
            }
        ...
        private int Consecutivo_Empresa()
        {
            ...
            {
                throw new Exception("Consecutivo_Empresa: " + exc.Message);
            }
        ...
        public void Crea_Directorio_Emp(string pszEmpresa)
        {
            ...
            {
                throw new Exception("Crea_Directorio_Emp: " + exc.Message);
            }
        ...
        public void Depura_Tabla_CamMasivos(ref  string pszParametro, ref  string pszNumEmpresa)
        {
            ...
            {
                throw new Exception("Depura_Tabla_CamMasivos: " + exc.Message);
            }
        ...
        private string Existen_Blancos()
        {
            ...
            try
            {
                ...
                /*else if (ObjSucursalPromotora == null) SE EMPATA versión de Producción 13/01/10
                {
                    Fichero (3);
                    CboSucPromotora.Focus();
                    return "Debe elegir una sucursal promotora valida";
                }
                else if (ObjSucursalPromotora.Status == "N")
                {
                    Fichero (3);
                    CboSucPromotora.Focus();
                    return "La sucursal promotora está inactiva favor d elegir otra";
                }*/
                else if (ObjSucursalPromotora == null)
                {
                    ...
                    {
                        ObjSucursalPromotora = new clsSucursal();
                    }
                }
                else if ((ObjSucursalPromotora.Status == "N") && (Tag.ToString() == CORCONST.TAG_ALTA))
                {
                    Fichero(3);
                    CboSucPromotora.Focus();
                    return "La sucursal promotora está inactiva favor d elegir otra";
                ...
                if (Double.Parse(ID_MEM_SUC_ITB.CtlText) < CORVB.NULL_INTEGER)
                {
                    Fichero(4);
                    ID_MEM_SUC_ITB.Focus();
                    return "Sucursal";
            ...
            {
                throw new Exception("Existen_Blancos: " + exc.Message);
            }
        ...
        public void Fichero(int iIndice)
        {
            ...
            {
                throw new Exception("Fichero: " + exc.Message);
            }
        }
        ...
        private bool InsertaTablaCambios(ref  string pszNumEmp, ref  string pszGpoBanco)
        {
            ...
            try
            {
                ...
                //EISSA 05.11.2001 Código para verificar que existan tarjetahabientes en MTCEJE01 y/o MTCTHS01
                //  pszgblsql = "SELECT "
                //  pszgblsql = pszgblsql & " isnull (THS.emp_num, EJE.emp_num) AS eje_num"
                //  pszgblsql = pszgblsql & " FROM MTCTHS01 THS, MTCEJE01 EJE"
                //  pszgblsql = pszgblsql & " Where"
                //  pszgblsql = pszgblsql & " EJE.eje_prefijo =* THS.eje_prefijo "
                //  pszgblsql = pszgblsql & " AND EJE.gpo_banco =* THS.gpo_banco "
                //  pszgblsql = pszgblsql & " AND EJE.emp_num =* THS.emp_num "
                //  pszgblsql = pszgblsql & " AND EJE.eje_num =* THS.eje_num "
                //  pszgblsql = pszgblsql & " AND THS.eje_prefijo = " & Format$(igblPref)
                //  pszgblsql = pszgblsql & " AND THS.gpo_banco = " & Format$(igblBanco)
                //  pszgblsql = pszgblsql & " AND THS.emp_num = " & pszNumEmp
            ...
            {
                throw new Exception("InsertaTablaCambios: " + exc.Message);
            }
            ...
            if (ActivateHelper.myActiveForm != eventSender)
            {
                ...
                switch (this.Tag.ToString())
                {
                    case CORCONST.TAG_CAMBIO:
                        ...
                        mskNumEmp.Enabled = false;
                        mskDiaCorte.Enabled = false;
                        ID_MEM_NCT_EB.Enabled = true;  //El nombre corto no puede ser modificado 
                    ...
                    case CORCONST.TAG_CONSULTA:
                        ...
                        ID_MEM_EJE_FRM.Enabled = false;
                        _fraDatosAdicionales_0.Enabled = false;
                        _fraDatosAdicionales_3.Enabled = false;
                        ...
                        //    fraDatosAdicionales[0].Enabled = false;
                        //}
                        //catch (Exception e1) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e1); }
                        //try
                        //{
                        //    fraDatosAdicionales[1].Enabled = false;
                        //}
                        //catch (Exception e11) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e11); }
                        //try
                        //{
                        //    fraDatosAdicionales[2].Enabled = false;
                        //}
                        //catch (Exception e2) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e2); }
                        //try
                        //{
                        //    fraDatosAdicionales[3].Enabled = false;
                        //}
                        //catch (Exception e3) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e3); }
                        //try
                        //{
                        //    fraDatosAdicionales[4].Enabled = false;
                        //}
                        //catch (Exception e4) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e4); }
                        //try
                        //{
                        //    fraDatosAdicionales[5].Enabled = false;
                        //}
                        //catch (Exception e5) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e5); }
                        //try
                        //{
                        //    fraDatosAdicionales[6].Enabled = false;
                        //}
                        //catch (Exception e6) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e6); }
                        try
                        {
                            ID_MEM_OK_PB.Enabled = false;
                        }
                        catch (Exception e7) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e7); }
                        try
                        {
                            ID_MEM_OK_PB.Visible = false;
                        }
                        catch (Exception e8) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e8); }
                        try
                        {
                            ID_MEM_NNA_EB.Visible = true;
                        }
                        catch (Exception e9) { CRSGeneral.prObtenError(this.GetType().Name + "(CORMNEMP_Activated)", e9); }
                        try
                        {
        ...
        private void Form_Load()
        {
            ...
            {
                throw new Exception("Form_Load: " + exc.Message);
            }
        ...
        private void ID_MEM_BOR_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                throw new Exception("ID_MEM_BOR_PB_Click: " + exc.Message);
            }
        }
        ...
        private void ID_MEM_NOM_EB_Enter(Object eventSender, EventArgs eventArgs)
        {
           ...
           try
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_MEM_NOM_EB_Enter)", exc);
                //throw new Exception("Migration Exception: The following exception could be handled in a different way after the conversion: " + exc.Message);
            }
        ...
        private bool EnvAccConexionEmp()
        {
            ...
            {
                throw new Exception("EnvAccConexionEmp: " + exc.Message);
            }
        ...
        private void Limpia_Controles()
        {
            ...
            try
            {
                ...
                mskNumEmp.SelStart = 0;
                mskNumEmp.SelLength = Strings.Len(mskNumEmp.defaultText);
                mskNumEmp.SelText = ""; //Numero de la Empresa
                mskNumEmp.Mask = "#####";
            ...
            {
                throw new Exception("Limpia_Controles: " + exc.Message);
            }
        }
        ...
        private int Obtiene_DatosEmpresa()
        {
            ...
            string strSucPromotora = String.Empty;
            ...
            try
            {
                ...
                CORVAR.pszgblsql = "select a.ejx_numero,emp_nom,emp_nom_graba,emp_rfc,emp_num_cartera,emp_princ_acc,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_sector,emp_cred_tot,convert(varchar(10),emp_fec_venc_cred,103),emp_fiscal_calle,emp_fiscal_col,emp_fiscal_ciu,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_fiscal_pob,emp_fiscal_edo,emp_fiscal_cp,emp_telefono,emp_envio_calle,emp_envio_col,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_tel_lada,emp_fax,emp_param_modem,emp_vel_transmis, emp_email,emp_internet,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_envio_ciu,emp_envio_pob,emp_envio_edo,emp_envio_cp,emp_cta_capt,emp_sucur,emp_tipo_pago,emp_tipo_envio,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_nom_r1,emp_pues_r1,emp_tel_r1,emp_ext_r1,emp_fax_r1,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_nom_r2,emp_pues_r2,emp_tel_r2,emp_ext_r2 , emp_fax_r2, ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "emp_nom_r3,emp_pues_r3,emp_tel_r3,emp_ext_r3,emp_fax_r3,";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "(select isnull(sum(eje_limcred),0) from  MTCEJE01";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " Where MTCEJE01.eje_prefijo = a.eje_prefijo";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " and MTCEJE01.gpo_banco = a.gpo_banco";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " and MTCEJE01.emp_num = a.emp_num";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " and MTCEJE01.eje_num > 0) as emp_acum_cred";
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = ' ' THEN 'CTA. NORMAL ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = 'O' THEN 'SOBREGIRADA' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = 'P' THEN 'PROB. COBRO ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = 'E' THEN 'CANC.C/SALD ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = 'C' THEN 'CANC.S/SALD ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = 'D' THEN 'ATRAZADA     ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " WHEN c.ths_situacion_cta = NULL THEN '- - - - - - - - - - - ' ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " END ";
                //'*** FIN:OLV NOV182004 ***
                CORVAR.pszgblsql = CORVAR.pszgblsql + "  FROM " + CORBD.DB_SYB_EMP + " a ," + CORBD.DB_SYB_EJE + " b," + CORBD.DB_SYB_THS + " c ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " where ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "  a.eje_prefijo = b.eje_prefijo and a.gpo_banco = b.gpo_banco and a.emp_num = b.emp_num and b.eje_num = 0 ";
                CORVAR.pszgblsql = CORVAR.pszgblsql + "  And a.eje_prefijo = " + mdlParametros.gprdProducto.PrefijoL.ToString() + " And a.gpo_banco = " + mdlParametros.gprdProducto.BancoL.ToString() + " And a.emp_num = " + CORVAR.lgblNumEmpresa.ToString();
                //'*** INI:OLV NOV182004 ***
                CORVAR.pszgblsql = CORVAR.pszgblsql + " AND b.eje_prefijo *= c.eje_prefijo";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " AND b.gpo_banco *= c.gpo_banco";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " AND b.emp_num *= c.emp_num";
                CORVAR.pszgblsql = CORVAR.pszgblsql + " AND b.eje_num *= c.eje_num";
                //'*** FIN:OLV NOV182004 ***
                ...
                if (CORPROC2.Obtiene_Registros() != 0)
                {
                    if (VBSQL.SqlNextRow(CORVAR.hgblConexion) == VBSQL.MOREROWS)
                    {
                        mskNumEmp.defaultText = StringsHelper.Format(CORVAR.lgblNumEmpresa, Formato.sMascara(Formato.iTipo.Empresa));
                        mskNumEmp.Enabled = false;
                        ...
                        strSucPromotora = VBSQL.SqlData(CORVAR.hgblConexion, 69);

                        pszEstatusEmp = VBSQL.SqlData(CORVAR.hgblConexion, 70);
                        ...
                        //{
                        //    //UPGRADE_WARNING: (6021) Casting 'int' to Enum may cause different behaviour.
                        //    ChkCDF.CheckState = (CheckState)Int32.Parse(VBSQL.SqlData(CORVAR.hgblConexion, 70));
                        //}
                        ...
                        //'Busca la sucursal promotora actual en la lista de combos
                        ID_MEM_NOM_COB_SelectedIndexChanged(ID_MEM_NOM_COB, new EventArgs());

                        if ((strSucPromotora == "") || (strSucPromotora == "    "))
                        {
                            CboSucPromotora.SelectedIndex = -1;
                        }
                        else
                        {
                            for (CORVAR.igblRetorna = 0; CORVAR.igblRetorna < CboSucPromotora.Items.Count; CORVAR.igblRetorna++)
                            {
                                if (VB6.GetItemData(CboSucPromotora, CORVAR.igblRetorna) == int.Parse(strSucPromotora))
                                {
                                    CboSucPromotora.SelectedIndex = CORVAR.igblRetorna;
                                    CboSucPromotora_SelectedIndexChanged(CboSucPromotora, new EventArgs());
                                    break; //'El elemento ya se encontro
                                }
                            }
                        }
                        //'Valida que el objeto haya sido inicializado
                        /*if (ObjSucursalPromotora == null)
                        {
                            ColSucursalPromotora = new Collection();
                            CboSucPromotora.Items.Add(strSucPromotora + " SUCURSAL NO EN CATALOGO");
                            CboSucPromotora.SelectedIndex = 0;
                        }SE EMPATA LA versión de PRODUCCIÓN 13/01/10 */
                        if (ObjSucursalPromotora == null)
                        {
                            ColSucursalPromotora = new Collection();
                            CboSucPromotora.Items.Add(strSucPromotora + " SUCURSAL NO EN CATALOGO");
                            CboSucPromotora.SelectedIndex = CboSucPromotora.Items.Count - 1;
                        }
            ...
            {
                throw new Exception("Obtiene_DatosEmpresa: " + exc.Message);
            }
        ...
        private int Obtiene_Ejecutivos()
        {
            ...
            {
                throw new Exception("Obtiene_Ejecutivos: " + exc.Message);
            }
        ...
        private bool RealizaCambiosMasivosEmp(int pLngNumEmp, N_ActualizaS111.ClsConectaS111 objTransS111)
        {
            ...
            try
            {
                ...
                int iRegs;
                //string connectionString = "Dsn=c430;uid=c430_dbo;pwd=" + CORDBLIB.gsPassword + ";keeporgmultibyte=1" + ";Charset=iso_1;";
                string connectionString = "Dsn=c430;uid=c430_dbo;pwd=" + CORDBLIB.gsPassword + ";keeporgmultibyte=1" + ";Charset=iso_1" + ";EncryptPassword=1;";
                ...
                if (lTempRow != 0)
                {
                    ...
                    //
                    {
                        ...
                        pszTelPart = reader[11].ToString();
                        pszTelOfi = reader[12].ToString();
                        pszExt = reader[13].ToString();
                        ...
                        if ((pszCalle.Trim() == pszCNumAnt.Trim()) && (pszColonia.Trim() == pszColoniaAnt.Trim()) && (pszPob == (pszPobEmp + " " + pszEdoEmp)) && (Conversion.Val(pszCP) == Conversion.Val(lCpAnt.ToString())))
                        {
                            bCambio = false;

                            // Si solo cambia el telefono de la empresa
                            if ((iEjeNum == 0) && ((msTelefono.Trim() != pszTelOfi.Trim()) || (msTelExt.Trim() != pszExt.Trim())))
                            {
                                bCambio = true;
                            }
                        }
                        ...
                        if (slRFC.ToString()!=msRFC.ToString())
                        {
                            bCambio = true;
                        }
                        ...
                        { //si hay diferencias
                            ...
                            do
                            {
                                ...
                                StrError = objTransS111.GetMsgerror(ref tempRefParam1);
                            }
                    ...
                    {
                        Interaction.MsgBox("Algunos cambios no pudieron ser realizados, intente reenviarlos con la opción de Pendientes S111", (MsgBoxStyle)(((int)CORVB.MB_ICONINFORMATION) + ((int)CORVB.MB_OK)), CORSTR.STR_APP_TIT);
                    }
            ...
            {
                throw new Exception("RealizaCambiosMasivosEmp: " + exc.Message);
            }
        ...
        private void mskNumEmp_Enter(Object eventSender, EventArgs eventArgs)
        {
            mskNumEmp.SelStart = 0;
            mskNumEmp.SelLength = Strings.Len(mskNumEmp.defaultText);
        }

        private void mskNumEmp_Validating(Object eventSender, CancelEventArgs eventArgs)
        {
            bool Cancel = eventArgs.Cancel;
            if (this.Tag.ToString() == CORCONST.TAG_ALTA)
            {
                if (mskNumEmp.defaultText.Trim() != "")
                    if (!fncValidaNumEmpresa(int.Parse(mskNumEmp.defaultText)))
                    {Cancel = true;}
            }
            eventArgs.Cancel = Cancel;
        }
        ...
        */
        ...
        private bool bfncActualizaEjecutivos(int lpEjePrefijo, int lpBanco, int lpEmpresa)
        {
            ...
            catch (Exception e)
            {
                ...
                CRSGeneral.prObtenError("ActualizaEjecutivos",e);
            }
                ...
                if (Tag.ToString() == CORCONST.TAG_CAMBIO)
                {
                    if (ComparaDatosCambio())
                    {
                        ...
                        objTransS111 = new N_ActualizaS111.ClsConectaS111();     
                            ...
                            string pszRFC = Seguridad.fncsSustituir(ID_MEM_RFC_MKE.CtlText, "-", "");
                            pszRFC = "'" + CORPROC.Valida_Comilla(pszRFC) + "'"; //RFC
                            string pszCartera = Conversion.Val("0.0").ToString(); //No de cartera
                            string pszAccionista = "'" + CORPROC.Valida_Comilla(ID_MEM_PAC_EB.Text) + "'"; //Principal accionista
                            string pszSector = Strings.Mid(ID_MEM_SEC_COB.Text, 2, 1); //Sector al que pertenece
                            //int pszCreditoGlobal = Int32.Parse(ID_MEM_CRE_FTB.CtlText); //Crédito total asignado
                            ...
                            if (Tag.ToString() == CORCONST.TAG_ALTA)
                            {
                                ...
                                //CORVAR.pszgblsql = CORVAR.pszgblsql + " where con_pref = " + CORVAR.igblPref.ToString();
                                //CORVAR.pszgblsql = CORVAR.pszgblsql + " and con_banco = " + CORVAR.igblBanco.ToString();
                                //if (CORPROC2.Obtiene_Registros() != 0)
                                //{
                                //    while (VBSQL.SqlNextRow(CORVAR.hgblConexion) != VBSQL.NOMOREROWS)
                                //    {
                                ...
                                if (lNumEmpresa <= 0)
                                {
                                    MessageBox.Show("Se ha generado un número de empresa no valida, por favor intentelo nuevamente.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Information);
                                    this.Cursor = Cursors.Default;
                                    return;
                                }
                                ...
                                lNumEmpresa = int.Parse(mskNumEmp.defaultText);
                                lcteCliente.PrefijoL = mdlParametros.gprdProducto.PrefijoL;
                                lcteCliente.BancoL = mdlParametros.gprdProducto.BancoL;
                                lcteCliente.EmpresaL = StringsHelper.IntValue(StringsHelper.Format(lNumEmpresa, Formato.sMascara(Formato.iTipo.Empresa)));
                                //***** JPU *****

                                slCuentaEjecutivo0 = StringsHelper.Format(CORVAR.igblPref, "0000") + StringsHelper.Format(CORVAR.igblBanco, "00") + StringsHelper.Format(lNumEmpresa, Formato.sMascara(Formato.iTipo.Empresa)) + StringsHelper.Format(0, Formato.sMascara(Formato.iTipo.Ejecutivo)) + "9";
                                ilDigitoVer = CORPROC.Calcula_digito_verif(ref slCuentaEjecutivo0);
                                ...
                                dlgAlta.sApellidoMaterno = Strings.Mid(Seguridad.fncsSustituir(Seguridad.fncsSustituir(Seguridad.fncsSustituir(pszNomEmpresa, ",", ""), ".", ""), "'", ""), 31, 30);
                                dlgAlta.sSexo = "F";
                                dlgAlta.iSucTransmisora = 342;
                                dlgAlta.iSucPromotora = ObjSucursalPromotora.IdSucursal;
                                if (slTipoFactura == CRSParametros.cteIndividual)
                                {
                                    dlgAlta.lLimiteCredito = 0;
                                }
                                ...
                                //dlgAlta.sAtencionA = pszAtencionA; //FSWB NR 20070223 Se incluyen campos Atencion A y Persona
                                ...
                                mdlParametros.sgDialogo = pszMensajeS016;

                                /*ilBanderaAlta = StringsHelper.IntValue(CRSGeneral.vfncVPO(ifncAltaEnS111(ref pszMensajeS111, pszMensajeS016, dlgAlta, ref sEnviaRut).ToString(), "0"));*/

                                if (ilBanderaAlta == CRSDialogo.cteAltaNO)
                                { //No se hizo el alta correcta
                                    //UPGRADE_WARNING: (6021) Casting 'int' to Enum may cause different behaviour.
                                    //UPGRADE_WARNING: (1046) MsgBox Parameter 'context' is not supported, and was removed.
                                    //UPGRADE_WARNING: (1046) MsgBox Parameter 'helpfile' is not supported, and was removed.
                                ...
                                else if (ilBanderaAlta == ((int)CRSDialogo.MensajesS016.cteExisteEnS016))
                                {  //Contrato existe en el S016
                                    //CORVAR.pszgblsql = "UPDATE MTCCON01";
                                    //CORVAR.pszgblsql = CORVAR.pszgblsql + " SET con_emp = " + (lNumEmpresa + 1).ToString();
                                    ...
                                    //if (CORPROC2.Modifica_Registro() != 0)
                                    //{
                                    MessageBox.Show("La cuenta " + dlgAlta.sCuenta + " ya existe en el Sistema S016.", "Tarjeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    //}
                                    //CORVAR.igblRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion);
                                    this.Cursor = Cursors.Default;

                                }
                                else if (ilBanderaAlta == ((int)CRSDialogo.MensajesS111.cteExisteEnS111))
                                {  //Contrato existe en el S111
                                    MessageBox.Show("La cuenta " + dlgAlta.sCuenta + " ya existe en el Sistema S111" + "\r\n" + "Avisar a Ing. de Sistemas.", this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    CORVAR.igblRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion);
                                    this.Cursor = Cursors.Default;

                                }
                                else if (ilBanderaAlta == CRSDialogo.cteAltaS016OK)
                                {  //Se dio de alta solo en el S016
                                    //CORVAR.pszgblsql = "UPDATE MTCCON01";
                                    //CORVAR.pszgblsql = CORVAR.pszgblsql + " SET con_emp = " + (lNumEmpresa + 1).ToString();
                                    //CORVAR.pszgblsql = CORVAR.pszgblsql + " WHERE con_pref = " + mdlParametros.gprdProducto.PrefijoL.ToString();
                                    ...
                                    //if (CORPROC2.Modifica_Registro() != 0)
                                    //{
                                    MessageBox.Show("La cuenta " + dlgAlta.sCuenta + " se dio solamente de alta en el Sistema S016.", "Tarjeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    //}
                                    //CORVAR.igblRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion);
                                    this.Cursor = Cursors.Default;

                                }
                                else if (ilBanderaAlta == CRSDialogo.cteAltaOK)
                                {  //Se hizo el alta correcta
                                    //EISSA 26.11.2001 Código Nuevo para alta de empresa
                                    //EISSA 07.10.2003 llamando a los parametros del stored procedure
                                    //de manera explicita
                                    CORVAR.pszgblsql = "exec alta_empresa ";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@nombre = " + pszNomEmpresa + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@prefijo= " + CORVAR.igblPref.ToString() + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@banco= " + pszBanco + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@pszNumGrupo= " + pszNumGrupo + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@pszNominaEjeBNX =" + pszNominaEjeBNX + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@pszNomCorto= " + pszNomCorto + ",";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + "@pszRFC= " + pszRFC;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCartera= 0";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszAccionista=" + pszAccionista;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszSector=" + pszSector;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCreditoGlobal =0";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCredAcum= " + Conversion.Str(0);
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszFecVenCred= convert(varchar(10), getdate(), 103)";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCalleFis= " + pszCalleFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszColoniaFis=" + pszColoniaFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCiudadFis = " + pszCiudadFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszPoblacionFis =" + pszPoblacionFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszEstadoFis= " + pszEstadoFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCpFis= " + pszCpFis;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszTelefono= " + pszTelefono;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszTelExt=" + pszTelExt;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszLada= " + pszLada;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszFax= " + pszFax;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pzsFaxLada= " + pszFaxLada;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszTonoPul= '" + pszTonoPul + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@iVelTrns= " + Conversion.Str(0);
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszEmail= " + pszEmail;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszInternet=" + pszInternet;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCalleEnv= " + pszCalleEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszColoniaEnv=" + pszColoniaEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCiudadEnv= " + pszCiudadEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszPoblacionEnv =" + pszPoblacionEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszEstadoEnv=" + pszEstadoEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCpEnv=" + pszCpEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszCtaCaptacion = " + pszCtaCaptacion;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszSucursal=" + pszSucursal;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszTipoPago1= " + pszTipoPago;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@pszTipoEnv=" + pszTipoEnv;
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipDiaCorte= " + ilDiaCorte.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipPlazoGracia = " + ilPlazoGracia.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipPlazoNoCobro =" + ilPlazoNoCobro.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipTablaMCC=" + ilTablaMCC.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipGeneraSBF =" + "0";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@spTipoFactura = '" + slTipoFactura + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@spEsquemaPago = '" + slEsquemaPago + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@cpTipoProducto ='" + slTipoProducto + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipEstructuraGastos =" + llEstructuraGastos.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipMesFiscal  =" + ilMesFiscal.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@spUsuarioCambio = '" + slUsuarioCambio + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipPorcentajeMinimo =" + ilMontoPorciento.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@dpMontoMinimoFacturar =" + dlFacturacionMinima.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@cpCuentaContable ='" + slCuentaContable + "'";
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@spSkipPayment= " + ilSkipPayment.ToString();
                                    CORVAR.pszgblsql = CORVAR.pszgblsql + ",@ipGenArchCDF= 0";
                                    //FSWB NR NOTA NO SE CAMBIO SP NO SE USA...
                                    ...
                                    if (CORPROC2.Modifica_Registro() != 0)
                                    {
                                        ...
                                        //pszgblsql = pszgblsql & "emp_gen_CDF = " &
                                        CORVAR.pszgblsql = CORVAR.pszgblsql + "WHERE eje_prefijo = " + CORVAR.igblPref.ToString() + " and gpo_banco = " + CORVAR.igblBanco.ToString() + " AND emp_num = " + pszNumEmpresa;
                                        ...
                                        if (CORPROC2.Modifica_Registro() != 0)
                                        {
                                            ...
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + pszTelExt;
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + pszFax;
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", 0"; //Limite de Crédito
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", 1 "; //Region
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", 'N' ";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", '' ";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", 'F' ";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", '342' "; //& Trim(pszSucursal) & "'"
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", '" + ObjSucursalPromotora.IdSucursal + "'"; //& Trim(pszSucursal) & "'"
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", 'E'";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", '03'"; //Actividad / Subactividad
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + pszEstadoEnv;
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + pszCalleEnv; //Domicilio Calle
                                            ...
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", convert(int,convert(char(20), getdate(),112))";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", convert(int,datepart(hh,getdate())) * 100 + convert(int, datepart(mi,getdate()))";
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + mdlParametros.igEmpTipoBloqueo.ToString();
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", " + pszNominaEjeBNX;

                                            //FSWB NR 20070223  CAMBIO??
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", ' '"; //FSWB NR 20070223
                                            CORVAR.pszgblsql = CORVAR.pszgblsql + ", '2')"; //FSWB NR 20070223
                            ...
                            else
                            {
                                ...
                                if ((Conversion.Val(pszNominaEjeBNX) != Conversion.Val(mlNominaEjeBNX.ToString())) || (pszNomEmpresa.Trim() != ("'" + msNomEmpresa.Trim() + "'")) || (pszNomCorto.Trim() != ("'" + msNomCorto.Trim() + "'")) || (pszRFC.Trim() != ("'" + msRFC.Trim() + "'")) || (pszAccionista.Trim() != ("'" + msAccionista.Trim() + "'")) || (Conversion.Val(pszSector) != Conversion.Val((miSector + 1).ToString())) || (Conversion.Val(pszCredAcum) != Conversion.Val(mlCredAcum.ToString())) || (pszCalleFis.Trim() != ("'" + msCalleFis.Trim() + "'")) || (pszColoniaFis.Trim() != ("'" + msColoniaFis.Trim() + "'")) || (pszCiudadFis.Trim() != ("'" + msCiudadFis.Trim() + "'")) || (pszPoblacionFis.Trim() != ("'" + msPoblacionFis.Trim() + "'")) || (pszEstadoFis.Trim() != ("'" + msEstadoFis.Trim() + "'")) || (Conversion.Val(pszCpFis) != Conversion.Val(mlCpFis.ToString())) || (pszTonoPul != ("'" + msTonoPul.Trim() + "'")) || (Conversion.Val(iVelTrns) != Conversion.Val(miVelTrns.ToString())) || (Conversion.Val(ID_MEM_CON_TXT.Text) != Conversion.Val(msTelefono)) || (Conversion.Val(ID_MEM_LADA_TXT.Text) != Conversion.Val(msLada)) || (Conversion.Val(ID_MEM_FAX_TXT.Text) != Conversion.Val(msFax)) || (pszEmail.Trim() != ("'" + msEmail.Trim() + "'")) || (pszInternet.Trim() != ("'" + msInternet.Trim() + "'")) || (Conversion.Val(pszCtaCaptacion) != Conversion.Val(mdCtaCaptacion.ToString())) || (Conversion.Val(pszSucursal) != Conversion.Val(miSucursal.ToString())) || (pszNombreR1.Trim() != ("'" + msNombreR1.Trim() + "'")) || (pszPuestoR1.Trim() != ("'" + msPuestoR1.Trim() + "'")) || (Conversion.Val(pszTelR1) != Conversion.Val(msTelR1)) || (Conversion.Val(pszExtR1) != Conversion.Val(msExtR1)) || (Conversion.Val(pszFaxR1) != Conversion.Val(pszFaxR1)) || (pszNombreR2.Trim() != ("'" + msNombreR2.Trim() + "'")) || (pszPuestoR2.Trim() != ("'" + msPuestoR2.Trim() + "'")) || (Conversion.Val(pszTelR2) != Conversion.Val(msTelR2)) || (Conversion.Val(pszExtR2) != Conversion.Val(msExtR2)) || (Conversion.Val(pszFaxR2) != Conversion.Val(pszFaxR2)) || (pszNombreR3.Trim() != ("'" + msNombreR3.Trim() + "'")) || (pszPuestoR3.Trim() != ("'" + msPuestoR3.Trim() + "'")) || (Conversion.Val(pszTelR3) != Conversion.Val(msTelR3)) || (Conversion.Val(pszExtR3) != Conversion.Val(msExtR3)) || (Conversion.Val(pszFaxR3) != Conversion.Val(pszFaxR3)))
                                { //FSWB NR 20070223
                                ...
                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_rfc= " + pszRFC;
                                ...
                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_min_factura = " + dlFacturacionMinima.ToString();
                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_cta_contable = '" + slCuentaContable + "'";
                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_gen_CDF= 0";

                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_atn_a = ' '"; //FSWB NR 20070223
                                CORVAR.pszgblsql = CORVAR.pszgblsql + ",emp_tipo_persona= 2"; //FSWB NR 20070223
            ...
            try
            {
                ...
                switch (ipTipoCambio)
                {
                    ...
                    case CRSDialogo.TipoCambioS111.cteCredito:
                        ...
                        CORMDIBN.DefInstance.ID_COR_MSG_TXT.Text = "Realizando Cambio de Límite de Uso";
        ...
        private void prAlta_Empresa()
        {
            ...
            try
            {
                ...
                string pszRFC = Seguridad.fncsSustituir(ID_MEM_RFC_MKE.CtlText, "-", "");
                pszRFC = "'" + CORPROC.Valida_Comilla(pszRFC) + "'"; //RFC
                //string pszCartera = Conversion.Val("0.00").ToString(); //No de cartera
                string pszAccionista = "'" + CORPROC.Valida_Comilla(ID_MEM_PAC_EB.Text) + "'"; //Principal accionista
                string pszSector = Strings.Mid(ID_MEM_SEC_COB.Text, 2, 1); //Sector al que pertenece
                //int pszCreditoGlobal = Int32.Parse(ID_MEM_CRE_FTB.CtlText); //Crédito total asignado
                ...
                pszFirma3 = "0x0";
                    ...
                    //Alta del primer tarjetahabiente con el Número de Ejecutivo 0
                    lNumEmpresa = int.Parse(mskNumEmp.defaultText);
                    lcteCliente.EmpresaL = lNumEmpresa;
                    lcteCliente.PrefijoL = mdlParametros.gprdProducto.PrefijoL;
                    lcteCliente.BancoL = mdlParametros.gprdProducto.BancoL;
                    lcteCliente.EmpresaL = StringsHelper.IntValue(StringsHelper.Format(lNumEmpresa, Formato.sMascara(Formato.iTipo.Empresa)));
                    ...
                    dlgAlta.sTipoFacturacion = slTipoFactura;
                    dlgAlta.sAtencionA = " "; //FSWB NR 20070223
                    dlgAlta.iPersona = 0; //FSWB NR 20070223
                    ...
                    //lAltaEmp.pszFecVenCred = szFecVenCred;
                    ilDiaCorte = Convert.ToInt32(Conversion.Val(mskDiaCorte.CtlText));
                    ...
                    lAltaEmp.ilGenArchivoCDF = 0;
                    lAltaEmp.bmblModFirma = CORVAR.bgblModFirma != 0;
                    lAltaEmp.smblPathRepEmpresas = CORVAR.pszgblPathRepEmpresas;

                    lAltaEmp.pszSucTransmisora = dlgAlta.iSucTransmisora.ToString();
                    lAltaEmp.pszSucPromotora = dlgAlta.iSucPromotora.ToString();

                    lAltaEmp.ilPersona = 0; //FSWB NR 20070228 Se agregan Atencion A y persona
                    lAltaEmp.slAtencionA = " "; //FSWB NR 20070228

                    lcteCliente.EmpresaL = lNumEmpresa;
                    lAltaEmp.EmplcteCliente = lcteCliente;
                    lAltaEmp.illNumEmpresa = lcteCliente.EmpresaL;
                    ...
                    #endregion alta empresa
                
            }
            catch (Exception exc)
            {
                throw new Exception("prAlta_Empresa: " + exc.Message);
            }
        ...
        private void CmdAgregarSucursal_Click(object sender, EventArgs e)
        {
            try
            {
                CORVAR.lgblEjxCve = int.Parse(Strings.Mid(ID_MEM_NOM_COB.Text, 1, 7));
        ...
        private void ID_MEM_NOM_COB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ObjSucursalPromotora = null;

            if (ID_MEM_NOM_COB.SelectedIndex > -1)
            {
                CboSucPromotora.Items.Clear();
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " Where ejx_numero=" + Strings.Mid(ID_MEM_NOM_COB.Text, 1, 7);
                ...
                if (CORPROC2.Obtiene_Registros() != 0)
                {
                    ...
                    {
                        ObjSucursalPromotora = new clsSucursal();
                        ObjSucursalPromotora.IdSucursal = int.Parse(VBSQL.SqlData(CORVAR.hgblConexion, 1));
                        ObjSucursalPromotora.Descripcion = VBSQL.SqlData(CORVAR.hgblConexion, 2);
                        ObjSucursalPromotora.Status = VBSQL.SqlData(CORVAR.hgblConexion, 3);
                        ColSucursalPromotora.Add(ObjSucursalPromotora, "K_" + ObjSucursalPromotora.IdSucursal, null, null);
                        CboSucPromotora.Items.Add(new ListBoxItem(StringsHelper.Format(ObjSucursalPromotora.IdSucursal, " 0000") + " " + ObjSucursalPromotora.Descripcion, ObjSucursalPromotora.IdSucursal));
                    }
                }
            }
            ObjSucursalPromotora = null;
        ...
        private void CboSucPromotora_SelectedIndexChanged(object sender, EventArgs e)
        {
            //'Busca la Sucursal Promotora actual
            int intIndex;
            ObjSucursalPromotora = null;
            intIndex = CboSucPromotora.SelectedIndex;
            if (intIndex > -1)
            {
                ObjSucursalPromotora = AsignaSucursal("K_" + VB6.GetItemData(CboSucPromotora, intIndex), intIndex);
                if (ObjSucursalPromotora != null)
                {
                    TbSucursalStatus.Text = ObjSucursalPromotora.Status;
                }
                else
                {
                    TbSucursalStatus.Text = "N";
                }
            }
            else
            { TbSucursalStatus.Text = ""; }

        }

        private void ID_MEM_NCT_EB_TextChanged(object sender, EventArgs e)
        {
