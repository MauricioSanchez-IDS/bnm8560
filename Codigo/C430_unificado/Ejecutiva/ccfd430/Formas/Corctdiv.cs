...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void Form_Load()
        {
            ...
            mdlParametros.gperPerfil.prHabilitaAcciones(CORCTDIV.DefInstance);
            this.Cursor = Cursors.Default;
        ...
        private void ID_DIV_BAJ_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_DIV_BAJ_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_DIV_CAM_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_DIV_CAM_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_DIV_CON_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_DIV_CON_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
