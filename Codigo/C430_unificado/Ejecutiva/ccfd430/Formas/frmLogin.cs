    ...
    public partial class frmLogin : Form
    {
        ...
        private int Carga_Bancos()
        {
            ...
            if (CORVAR.hgblConexion != 0)
            {
                ...
                {
                    //AIS-1182 NGONZALEZ
                    CORVAR.igblErr = API.USER.PostMessage(frmLogin.DefInstance.Handle.ToInt32(), CORVB.WM_CLOSE, CORVB.NULL_INTEGER, CORVB.NULL_INTEGER);
            ...
            try
            {
                ...
                if (SSS == "1")
                {
                   ...
                   // Seguridad.usugUsuario.NombreS = CRSParametros.sgUserName;
                    ...
                    CRSParametros.sgUserName = Seguridad.usugUsuario.NombreS;
