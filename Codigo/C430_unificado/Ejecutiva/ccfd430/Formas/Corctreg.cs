...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void Form_Load()
        {
            ...
            mdlParametros.gperPerfil.prHabilitaAcciones(CORCTREG.DefInstance);
            this.Cursor = Cursors.Default;
        ...
        private void ID_REG_ALT_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_REG_ALT_PB_Click)", e);
            }
        }
        ...
        private void ID_REG_BAJ_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_REG_BAJ_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_REG_CAM_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_REG_CAM_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_REG_CON_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_REG_CON_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
