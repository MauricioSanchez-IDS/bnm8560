...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        FarPoint.Win.Spread.CellType.CheckBoxCellType CorpdatchkCell = new FarPoint.Win.Spread.CellType.CheckBoxCellType();

        private ClsTuxedo _objConexionTuxedo = null;
        ...
        //private ClsTcpIp _objCnnTcpIp = null;
        ...
        private void Form_Load()
        {
            ...
            try
            {
                ...
                SpdReportes.set_ColWidth(3, 10);
                SpdReportes.Col = 4;
                SpdReportes.Text = "Generar";
                SpdReportes.Col = 5;
                SpdReportes.set_ColWidth(5, 30);
        ...
        private void SpdReportes_ButtonClicked(Object eventSender, FarPoint.Win.Spread.EditorNotifyEventArgs eventArgs)
        {
            ...
            int eButtonDown = 0;
            if (eventArgs.EditingControl.GetType() == typeof(CheckBox)) { if (((CheckBox)eventArgs.EditingControl).Checked) { eButtonDown = 1; } }
            ...
            try
            {
                if (eventArgs.Column == COL_GENERAREPORTE)
                {
                    ...
                    SpdReportes.GetText(3, eventArgs.Row, ref tempRefParam2);
                    strFrecuencia = tempRefParam2.ToString();
                    strFrecuencia = strFrecuencia.Trim();
                    ObjReporteProcesar = new ClsReporteGerencia();
                    ObjReporteProcesar.Col = eventArgs.Column;
                    ObjReporteProcesar.Id = "Row" + eventArgs.Row.ToString();
                    ObjReporteProcesar.Reporte = StringsHelper.IntValue(strNoreporte);
                    ObjReporteProcesar.Row = eventArgs.Row;
            ...
            try
            {
                ...
                if (VBSQL.OpenConn(10) == 0)
                {
                    ...
                    while (!rsReportes.EOF)
                    {
                        ...
                        SpdReportes.Col = 1;
                        SpdReportes.CellType = CorpdatCell;
                        ...
                        SpdReportes.Col = 2;
                        SpdReportes.CellType = CorpdatchkCell; //La columna acepta check box
                        SpdReportes.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Center; 
                        //UPGRADE_WARNING: (1068) Nvl() of type Variant is being forced to string.
                ...
                SpdReportes.Col = 4;
                SpdReportes.Row = -1; //Selecciona toda la columna del reporte
                SpdReportes.CellType = CorpdatchkCell; //La columna es de un grupo de check Box
                SpdReportes.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
