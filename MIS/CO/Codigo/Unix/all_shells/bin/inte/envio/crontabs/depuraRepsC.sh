...
#                     proceso de depuracion de Reportes de Debito 
# Version			: 1.0
# Modificacion --HP-           26-junio    HRC
...
exec 1>>$(paths.sh 03 LOG)/depuraRepsC.log
exec 2>>$(paths.sh 03 LOG)/depuraRepsCerr.log
