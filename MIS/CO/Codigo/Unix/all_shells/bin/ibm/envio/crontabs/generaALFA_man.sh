...
# Sistema       : C430
# Directorio	: /opt/c430/ibm/bin/envio/crontabs
# Descripcion   : Corre en forma manual el archivo CCF
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/optware/sybase/asesp157sp104/OCS-15_0/lib
...
#$DIR_ICEP/icep.sh intelarintmx1 gunix xunix send mb /opt/c430/000/bin/ibm/envio/deposito/$NOM_ARCH_ALFA C430_000.CITSGRAL.OS254100.TARJETA    #Produccion
