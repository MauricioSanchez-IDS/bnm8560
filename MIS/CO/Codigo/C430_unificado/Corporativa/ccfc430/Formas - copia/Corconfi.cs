		...
		: System.Windows.Forms.Form
		{
			...
			private void  ID_FIR_IMP_PB_Click( Object eventSender,  EventArgs eventArgs)
			{
					...
					try
					{
							...
							PrinterHelper.Printer.Print("NO. CARTERA            : " + CORMNEMP.DefInstance.ID_MEM_CAR_PIC.CtlText);
							...
							PrinterHelper.Printer.Print("CREDITO TOTAL ASIGNADO : " + CORMNEMP.DefInstance.ID_MEM_CRE_FTB.CtlText); //Crédito total asignado
					...
					{
                        MessageBox.Show("Fallo operación ID_FIR_IMP_PB_Click " + exc.Message, "Error Corconfi", MessageBoxButtons.OK, MessageBoxIcon.Error); 
