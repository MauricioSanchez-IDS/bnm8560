...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void Formatea_Spread()
        {
            ...
            ID_CEJ_REP_SS.Col = 1;
            ID_CEJ_REP_SS.set_ColWidth(1, 7);
            ID_CEJ_REP_SS.Text = "Número";

            ID_CEJ_REP_SS.Col = 2;
            ID_CEJ_REP_SS.set_ColWidth(2, 35);
            ...
            ID_CEJ_REP_SS.Col = 7;
            ID_CEJ_REP_SS.set_ColWidth(7, 10);
            ID_CEJ_REP_SS.Text = "Transac.";

            ID_CEJ_REP_SS.Col = 8;
            ID_CEJ_REP_SS.set_ColWidth(8, 14);
            ID_CEJ_REP_SS.Text = "Monto de Compras";

            ID_CEJ_REP_SS.Col = 9;
            ID_CEJ_REP_SS.set_ColWidth(9, 14);
            ID_CEJ_REP_SS.Text = "Monto de Disp.";

            ID_CEJ_REP_SS.Col = 10;
            ID_CEJ_REP_SS.set_ColWidth(10, 14);
