...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        FarPoint.Win.Spread.CellType.NumberCellType CormnrenCell = new FarPoint.Win.Spread.CellType.NumberCellType();
        FarPoint.Win.Spread.CellType.EditBaseCellType CormnrenCellEdit = new FarPoint.Win.Spread.CellType.EditBaseCellType();
        ...
        private void Calcula_totales(double iMaxRenglones)
        {
            ...
            for (int jCont = Convert.ToInt32(iMaxRenglones); jCont <= Convert.ToInt32(iMaxRenglones); jCont++)
            {
            ...
            //Totales
            sprRepRenta.Col = 1;
            FarPoint.Win.Spread.CellType.EditBaseCellType celdaTotales = new FarPoint.Win.Spread.CellType.EditBaseCellType();
            sprRepRenta.CellType = celdaTotales;
            sprRepRenta.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            ...
            sprRepRenta.set_ColWidth(6, iAncho * 4);


            if (CORCTREN.DefInstance.Tag.ToString() == "Una")
            {
                sprRepRenta.Col = 7;
                sprRepRenta.CellType = CormnrenCellEdit;
        ...
        private void Calcula_totales_Detalle(double iMaxRenglones)
        {
            ...
            sprRepRenta.set_ColWidth(3, iAncho * 4);
        ...
        private void Formatea_Spread()
        {
            ...
            {
                sprRepRenta.Col = 7;
                sprRepRenta.set_ColWidth(7, 18 * 3);
        ...
        private void Formatea_Spread_Detalle()
        {
            ...
            sprRepRenta.Col = 1;
            sprRepRenta.set_ColWidth(1, 17 * 10);
            ...
            sprRepRenta.Col = 3;
            sprRepRenta.set_ColWidth(3, 18 * 4);
            sprRepRenta.Text = "Ingresos";
            sprRepRenta.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ...
            {
                sprRepRenta.Col = 6;
                sprRepRenta.set_ColWidth(6, 18 * 3);
