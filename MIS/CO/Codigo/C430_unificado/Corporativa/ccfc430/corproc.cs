...
namespace TCc430
{
	class CORPROC
	{
		...
		//**                                                                        **
		//****************************************************************************
        static public void DDE_Excel(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
...
VuelveAIntentar: 
        ...
        static public void Guarda_TXT(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
        ...
        static public void Imprime_ANG(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
        ...
        static public void Imprime_CEJ(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
			iMaxRenglones = cSpread.MaxRows;
			iMaxcolumnas = cSpread.MaxCols;
        ...
        static public void Imprime_CGR(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
			iMaxRenglones = cSpread.MaxRows;
			iMaxcolumnas = cSpread.MaxCols;
        ...
        static public void Imprime_DAT(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
			int iCont = 0;
			int iEnter = 0;
        ...
        static public void Imprime_DEJ(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
        ...
        static public void Imprime_EMA(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
			iMaxRenglones = cSpread.MaxRows;
			iMaxcolumnas = cSpread.MaxCols;
        ...
        static public void Imprime_REN(Softtek.Util.Win.Spread.SpreadWrapper cSpread)
		{
			int ilComienzo = 0;
			iMaxRenglones = cSpread.MaxRows;
			iMaxcolumnas = cSpread.MaxCols;
		...
		static public void  Obten_Paths_Globales()
		{
            ...
            CORVAR.pszgblPathFirmas = mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Rutas", "Firmas").Trim();
            CORVAR.pszgblPathRepEmpresas = mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Rutas", "ReportesEmp").Trim();
            CORVAR.pszgblPathCorpo = CORVAR.pszgblPathRepEmpresas;
            //CORVAR.pszgblPathCorpo = DirExe.Trim() + "\\" + mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Rutas", "ReportesCorp").Trim();
            CORVAR.pszgblPathRepCorporativo=CORVAR.pszgblPathCorpo;
           // CORVAR.pszgblPathEXCEL = mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Rutas", "Excel").Trim();
            string pszIva = mdlParametros.valorRegistro(2, "SOFTWARE\\Banamex\\C430_001\\TarjetaCorporativa\\Parametros", "Iva").Trim();
