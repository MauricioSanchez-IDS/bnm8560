...
namespace TCc430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        //UPGRADE_NOTE: (7001) The following declaration (fncRealizaConexionRutB) seems to be dead code
        //private bool fncRealizaConexionRutB( mdlEjecutivo.enuTipoAltaSistema ipTipoAlta)
        //{
        //
        //bool result = false;
        //try
        //{
        //
        //if (ipTipoAlta == mdlEjecutivo.enuTipoAltaSistema.tasAltaS016)
        //{
        ...
        //}
        //
        //} else if (ipTipoAlta == mdlEjecutivo.enuTipoAltaSistema.tasAltaS111) { 
        //cnxConexionRut.Termina_Conexion();
        //if (cnxConexionRut.Inicia_Conexion())
        //{
        //result = true;
        ...
        //return result;
        //default:
        //MessageBox.Show("No hay conexión al S111. Avise a sistemas.", "Conexión S111", MessageBoxButtons.OK, MessageBoxIcon.Error); 
        //result = false; 
        //this.Cursor = Cursors.Default; 
        ////UPGRADE_TODO: (1065) Error handling statement (Resume Next) could not be converted properly. A throw statement was generated instead. 
        //throw new Exception("Migration Exception: 'Resume Next' not supported"); 
        ...
        //UPGRADE_NOTE: (7001) The following declaration (fncVerificaConexionB) seems to be dead code
        //private bool fncVerificaConexionB( mdlConexiones.enuTipoConexion ipTipoConexion)
        //{
        //
        //bool result = false;
        //OLERut.Conexion cnxlConexionRut = new OLERut.Conexion();
        ...
        //this.Cursor = Cursors.WaitCursor;
        //
        //if (ipTipoConexion == mdlConexiones.enuTipoConexion.tcnxConexionRut)
        //{
        //cnxlConexionRut.Termina_Conexion();
        //if (cnxlConexionRut.Inicia_Conexion())
        //{
        //result = true;
        //this.Cursor = Cursors.Default;
        //return result;
        ...
        //this.Cursor = Cursors.Default; 
        //break;
        //default: //No hay conexion con Rut 
        //MessageBox.Show("No hay conexión al S111. Avise a sistemas.", "Conexión S111", MessageBoxButtons.OK, MessageBoxIcon.Error); 
        //result = false; 
        //this.Cursor = Cursors.Default; 
        ////UPGRADE_TODO: (1065) Error handling statement (Resume Next) could not be converted properly. A throw statement was generated instead. 
        ...
        private void prLimpiaPantalla()
        {
            ...
            try
            {
                ...
                for (int ilContador = 0; ilContador <= 2; ilContador++)
                {
                    ...
                    {
                        try { cmbEjecutivos[ilContador].SelectedIndex = -1; }
                        catch { }
                    }
                }
        ...
        /// Fecha de ultima modificacion: 22/01/2018--> 
        /// </summary>
        private void FillFormTestData()
        {
            try
            {
                if (TestData.TestDataAltas.ExistTest())
                {
                    foreach (var item in TestData.TestDataAltas.getTestData())
                    {
                        ...
                        switch (Ctl)
                        {
                            ...
                            case "cmb":
                                ...
                                break;
                            case "optbtn":
                                RadioButton rd = (RadioButton)(this.Controls.Find(idCtl, true)[0]);
                                rd.Checked = Boolean.Parse(item.Value);
                                break;
                        }
                    }
                }
        ...
        private void mskEjecutivos_Validating(Object eventSender, CancelEventArgs eventArgs)
        {
            ...
            switch (Index)
            {
                ...
                case 2:  //Sueldo 
                    ...
                    break;
                case 3:  //Limite Credito 
                    if (Conversion.Val(mskEjecutivos[Index].CtlText) < 0 || Conversion.Val(mskEjecutivos[Index].CtlText) > mdlEmpresa.ctelLimiteCredito)
                    {
                        Cancel = true;
