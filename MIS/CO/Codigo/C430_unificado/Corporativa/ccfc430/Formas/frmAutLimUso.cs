        ...
        : System.Windows.Forms.Form
    {
        ...
        private bool mfnCargarMallaB()
        {
            ...
            try
            {
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " when lim_fecha_checker is null then ''";
                ...
                CORVAR.pszgblsql = CORVAR.pszgblsql + " and (lim_usu_checker is null or lim_usu_checker = ' ')";
                ...
                if (CORPROC2.Obtiene_Registros() != 0)
                {
                    ...
                    {
                        slCuenta = mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 3), "");
                        ...
                        object tempRefParam2 = "K" + Convert.ToString(MdlCambioMasivo.Nvl(VBSQL.SqlData(CORVAR.hgblConexion, 3), -1));
                        ...
                        ListItem.set_SubItems(1, StringsHelper.Format(mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 4), "0"), "$ ###,###,###,##0.00"));
                        object tempRefParam7 = lvwCuentas.ListItems.Count;
                        ListItem.set_SubItems(2, StringsHelper.Format(mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 5), "0"), "$ ###,###,###,##0.00"));
                        object tempRefParam8 = lvwCuentas.ListItems.Count;
                        ListItem.set_SubItems(3, mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 6), "").Trim());
                        object tempRefParam9 = lvwCuentas.ListItems.Count;
                        ListItem.set_SubItems(4, mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 7), "").Trim());
                        object tempRefParam10 = lvwCuentas.ListItems.Count;
                        ListItem.set_SubItems(5, mdlParametros.fncValorOmisionV(VBSQL.SqlData(CORVAR.hgblConexion, 8), ""));
                ...
                {
                    MessageBox.Show("No existen Solicitudes de Cambio de Límite de Crédito.", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    result = false;
                }
        ...
        private void tbrStandar_ButtonClick(Object eventSender, AxMSComctlLib.IToolbarEvents_ButtonClickEvent eventArgs)
        {
                ...
                switch (eventArgs.button.Key.ToUpper())
                {
                    ...
                    case "ENVIAR":
                        ...
                        if (RevisaSelB())
                        {
                            ...
                            accAccion.NombreS = "Autoriza Limite Crédito";
                            accAccion.DescripcionS = "Autoriza y actualiza Límite de Crédito en C430 y S111.";
                            ...
                            {
                                MessageBox.Show("Debe seleccionar alguna solicitud a enviar.", "Autorización de Límites de Crédito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                        }
                        this.Cursor = Cursors.Default;
                        break;
                    case "DECLINAR":
                        ...
                        {
                            MessageBox.Show("Debe seleccionar al menos un registro por declinar.", "Autorización de Límites de Crédito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        this.Cursor = Cursors.Default;
                        break;
                    case "ACTUALIZAR":
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(tbrStandar_ButtonClick)", e);
            }
        }
