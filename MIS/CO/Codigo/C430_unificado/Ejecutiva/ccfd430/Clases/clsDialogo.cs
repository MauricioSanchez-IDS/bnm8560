...
namespace TCd430
{
	internal class clsDialogo
	{
		...
		//' código para cambiar dirección en cambios masivos - jacm
		...
		public string strCP;
		public string strTelDomi;
		public string strTelOfi;
		public string strExt;
		public string strActividad;
		public string strSubActividad;
		public string strRFC;
		public string strPob_Edo;
		public clsCambiosMasivos objCambioMasivo;
		//' fin del código agregado - jacm
			...
			try
			{
				switch(ipTipoDlg)
				{
					...
					case enuTipoDialogo.tAltaEjecutivoS016 :  //***** Transaccion de Alta Ejecutivo S016 ***** 
							/* Se comenta este dialogo debido a que algunas cuentas hijas se dan de alta con una cuenta pade incorrecta
							dejelEjecutivo = null; 
							...
							dejelEjecutivo = (clsDatosEjecutivo)objpRepositorio;  //Se le pasa el valor de la Clase clsDatosEjecutivo 
							dejelEjecutivo.EjeCuentaS = (StringsHelper.Format(dejelEjecutivo.EjeProductoPRD.PrefijoL, dejelEjecutivo.EjeProductoPRD.MascaraPrefijoS) + StringsHelper.Format(dejelEjecutivo.EjeProductoPRD.BancoL, dejelEjecutivo.EjeProductoPRD.MascaraBancoS) + StringsHelper.Format(dejelEjecutivo.EjeEmpNumL, dejelEjecutivo.EjeProductoPRD.MascaraEmpresaS) + StringsHelper.Format(dejelEjecutivo.EjeNumL, dejelEjecutivo.EjeProductoPRD.MascaraEjecutivoS) + dejelEjecutivo.EjeRolloverI.ToString().Trim() + dejelEjecutivo.EjeDigitI.ToString().Trim()).Trim();
							// APQ 17-Feb-2010 Corrección Altas mal incorporadas a otra empresa
							dejelEjecutivo.EjeCuentaReferenciaS = "";
							dejelEjecutivo.EjeCuentaReferenciaS = mdlEjecutivo.fncCuentaPadreS(dejelEjecutivo.EjeProductoPRD.PrefijoL, dejelEjecutivo.EjeProductoPRD.BancoL, dejelEjecutivo.EjeEmpNumL);
							// APQ 17-Feb-2010 Corrección Altas mal incorporadas a otra empresa
							slDialogo = new String(' ', 1133);  //Variable local que va a tener el Dialogo 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 1, "C430");  //Sistema 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 5, mdlParametros.ctesProcesoAltaS016);  //Clave de proceso 
					...
					case enuTipoDialogo.tAltaEjecutivoS111 :  //***** Transaccion de Alta Ejecutivo S111 ***** 
							/* Se comenta este bloqueo debido a que algunas cuentas hijas se están dando de alta con una cuenta padre incorrecta
							dejelEjecutivo = null; 
							dejelEjecutivo = (clsDatosEjecutivo) objpRepositorio;  //Se le pasa el valor de la Clase clsDatosEjecutivo 
							dejelEjecutivo.EjeCuentaS = (StringsHelper.Format(dejelEjecutivo.EjeProductoPRD.PrefijoL, dejelEjecutivo.EjeProductoPRD.MascaraPrefijoS) + StringsHelper.Format(dejelEjecutivo.EjeProductoPRD.BancoL, dejelEjecutivo.EjeProductoPRD.MascaraBancoS) + StringsHelper.Format(dejelEjecutivo.EjeEmpNumL, dejelEjecutivo.EjeProductoPRD.MascaraEmpresaS) + StringsHelper.Format(dejelEjecutivo.EjeNumL, dejelEjecutivo.EjeProductoPRD.MascaraEjecutivoS) + dejelEjecutivo.EjeRolloverI.ToString().Trim() + dejelEjecutivo.EjeDigitI.ToString().Trim()).Trim(); 
							slDialogo = new String(' ', 1133);  //Variable local que va a tener el Dialogo */
					...
					case enuTipoDialogo.tCambioMCCEmpresaS111 :  //***** Transaccion de Cambio de MCC S111 ***** 
							...
							slDialogo = slDialogo + "G ";  //Subtransaccion 
					...
					case enuTipoDialogo.tCambioGenPinPlaEjecutivoS111 :  //***** Transaccion de Gen. Pin Pla Ejecutivo S111 ***** 
							this.mIdTransaccionS = "5368"; 
							this.mNumCuentaS = StringsHelper.Format(mdlParametros.tgCambioS111.NumCuentaS, "0000000000000000");  //Numero de Cuenta 
							slDialogo = slDialogo + "N ";  //Subtransaccion 
							slDialogo = slDialogo + mdlParametros.tgCambioS111.PinPlaI.ToString();  //Subtransaccion2 
							slDialogo = slDialogo + Strings.Chr(3).ToString(); 
							this.DialogoS = slDialogo; 
							break;
					case enuTipoDialogo.tCambioDirEjecutivoS111:  //***** Transaccion de Dirección Ejecutivo S111 ***** 
							objCambioMasivo = (clsCambiosMasivos)objpRepositorio;
							strNombre = objCambioMasivo.datosDir_NombreEjecutivo;
							strSexo = objCambioMasivo.datosDir_Sexo;
							strCalle = objCambioMasivo.datosDir_Calle;
							strColonia = objCambioMasivo.datosDir_Colonia;
							strZP = objCambioMasivo.datosDir_ZP;
							strPoblacion = objCambioMasivo.datosDir_Poblacion;
							strEstado = objCambioMasivo.datosDir_Estado;
							strCP = objCambioMasivo.datosDir_CP;
							strTelDomi = objCambioMasivo.datosDir_TelDomicilio;
							strTelOfi = objCambioMasivo.datosDir_TelOficina;
							strExt = objCambioMasivo.datosDir_Extension;
							strActividad = objCambioMasivo.datosDir_Actividad;
							strSubActividad = objCambioMasivo.datosDir_SubActividad;
							strRFC = objCambioMasivo.datosDir_RFC;
							if (strCalle.Length > 35)
							{
								strCalle = Strings.Mid(strCalle, 1, 26);
							}
							if (strColonia.Length > 25)
							{
								strColonia = Strings.Mid(strColonia, 1, 25);
							}
							if (strZP.Length < 2)
							{
								strZP = String.Format(strZP, "00");
							}
							else if (strZP.Length > 2)
							{
								strZP = Strings.Mid(strZP, 1, 2);
							}
							strPob_Edo = Strings.Space(25);
							strPoblacion = objCambioMasivo.datosDir_Poblacion;
							strEstado = objCambioMasivo.datosDir_Estado;
							//Strings.Mid(strPob_Edo, 1, 21) = Strings.Mid(strPoblacion, 1, 21);
							//Strings.Mid(strPob_Edo, 23, 3) = Strings.Mid(strEstado, 1, 3);
							strPob_Edo = StringsHelper.MidAssignment(strPob_Edo, 1, Strings.Mid(strPoblacion, 1, 21));
							strPob_Edo = StringsHelper.MidAssignment(strPob_Edo, 23, Strings.Mid(strEstado, 1, 3));
							objCambioMasivo.datosDir_Pob_edo = strPob_Edo;
							if (strTelDomi.Length < 7)
							{
								strTelDomi = String.Format(strTelDomi, "0000000");
							}
							if (strTelOfi.Length < 7)
							{
								strTelOfi = String.Format(strTelOfi, "0000000");
							}
							if (strExt.Length < 4)
							{
								strExt = String.Format(strExt, "0000");
							}
							slDialogo = "M" + Strings.Chr(28);                       //'Modificación
							slDialogo = slDialogo + strNombre + Strings.Chr(28);     //'Nombre
							slDialogo = slDialogo + strSexo + Strings.Chr(28);       //'Sexo
							slDialogo = slDialogo + strCalle + Strings.Chr(28);
							slDialogo = slDialogo + strColonia + Strings.Chr(28);
							slDialogo = slDialogo + strZP + Strings.Chr(28);
							slDialogo = slDialogo + objCambioMasivo.datosDir_Pob_edo + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(objCambioMasivo.datosDir_CP, "00000") + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(strTelDomi.Trim(),"0000000") + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(strTelOfi.Trim(), "0000000") + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(strExt.Trim(), "0000") + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(Strings.Mid(objCambioMasivo.datosDir_Actividad.Trim(), 1, 2), "00") + Strings.Chr(28);
							slDialogo = slDialogo + StringsHelper.Format(Strings.Mid(objCambioMasivo.datosDir_SubActividad.Trim(), 1, 2), "00") + Strings.Chr(28);
							slDialogo = slDialogo + strRFC + Strings.Chr(28);
							slDialogo = slDialogo + " ";
							this.DialogoS = slDialogo;
							this.mIdTransaccionS = CORCONST.MODIFICA_EMPRESA_MASIVOS; //'5199
							this.mNumCuentaS = String.Format(mdlParametros.tgCambioS111.NumCuentaS, "0000000000000000");
							break;
						//case clsDialogo.enuTipoDialogo.tCambioTipoBloqueoEjecutivoS111:  //***** Transaccion de Tipo Bloqueo Ejecutivo S111 ***** 
					...
					// Se realizan cambios en Direccion Envio por particular 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 418, dejelEjecutivo.EjeDomEnvioDMC.DomicilioS);  //Calle y Número //Cambia por la calle del domicilio 2// cambio Junio 6, 2016 APH
							//slDialogo = StringsHelper.MidAssignment(slDialogo, 418, dejelEjecutivo.EjeDomPartDMC.DomicilioS);  //Calle y Número 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 453, dejelEjecutivo.EjeDomEnvioDMC.ColoniaS);  //Colonia //Cambia por la colonia del domicilio 2// cambio Junio 6, 2016 APH
							//slDialogo = StringsHelper.MidAssignment(slDialogo, 453, dejelEjecutivo.EjeDomPartDMC.ColoniaS);  //Colonia 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 478, dejelEjecutivo.EjeDomEnvioDMC.PoblacionS);  //Poblacion //Cambia por la ciudad del domicilio 2// cambio Junio 6, 2016 APH
							...
							slDialogo = StringsHelper.MidAssignment(slDialogo, 499, StringsHelper.Format(dejelEjecutivo.EjeDomEnvioDMC.EstadoEST.CodigoI,"00"));  //Estado  //Cambi0 Junio 6, 2016 APH
							...
							slDialogo = StringsHelper.MidAssignment(slDialogo, 503, StringsHelper.Format(dejelEjecutivo.EjeDomEnvioDMC.CPL, "00000"));  //Codigo Postal //Cambia por el cp del estado 2// Cambio Junio 6, 2016 APH
					...
					// Se realizan cambios en Direccion Particular por Envio 
							slDialogo = StringsHelper.MidAssignment(slDialogo, 533, dejelEjecutivo.EjeDomPartDMC.DomicilioS);//new String(' ', 35));  //Direccion 1 //Calle Num2 // cambio Junio 6, 2016 APH
							//slDialogo = StringsHelper.MidAssignment(slDialogo, 533, dejelEjecutivo.EjeDomEnvioDMC.DomicilioS);
							slDialogo = StringsHelper.MidAssignment(slDialogo, 568, dejelEjecutivo.EjeDomPartDMC.ColoniaS);//new String(' ', 25));  //Direccion 2  // cambio Junio 6, 2016 APH
							...
							slDialogo = StringsHelper.MidAssignment(slDialogo, 593, dejelEjecutivo.EjeDomPartDMC.PoblacionS);//new String(' ', 21));  //CIUDAD-2   // cambio Junio 6, 2016 APH
							//slDialogo = StringsHelper.MidAssignment(slDialogo, 593, dejelEjecutivo.EjeDomEnvioDMC.PoblacionS);
							slDialogo = StringsHelper.MidAssignment(slDialogo, 614, StringsHelper.Format(dejelEjecutivo.EjeDomPartDMC.EstadoEST.CodigoI,"00"));//"00");  //ESTADO-2 // cambio Junio 6, 2016 APH
							...
							slDialogo = StringsHelper.MidAssignment(slDialogo, 616, StringsHelper.Format(dejelEjecutivo.EjeDomPartDMC.CPL, "00000")); // //Cambia por el cp del estado 2//  cambio Junio 6, 2016 APH
