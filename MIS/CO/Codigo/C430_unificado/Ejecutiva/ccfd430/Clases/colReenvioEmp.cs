...
namespace TCd430
{
	internal class colReenvioEmp
	{
		...
		private void  prArmaConsutaEmpresas()
		{
			...
			//FSWB NR CAMBIO ?
			CORVAR.pszgblsql = CORVAR.pszgblsql + " From MTCINE02 " + "\r\n";
		...
		public void  prCargarDatos()
		{
			...
			if (CORPROC2.Obtiene_Registros() != 0)
			{
				...
				while(VBSQL.SqlNextRow(CORVAR.hgblConexion) != VBSQL.NOMOREROWS)
				{
                    ...
                    objNewMember.pszSucPromotora = VBSQL.SqlData(CORVAR.hgblConexion, 91);
                    objNewMember.pszSucTransmisora = VBSQL.SqlData(CORVAR.hgblConexion, 92);
