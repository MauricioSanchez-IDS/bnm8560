...
namespace TCd430
{
    internal class clsCuenta
    {
        ...
        private N_TransS111.ClsConsulta NobjConsulta = null;
        ...
        public bool ConectarS111B(prySeguridadS041.clsUsuario usupUsuario)
        {
            ...
            //    if (usupUsuario != null)
            //    {
            //        mcnsS111 = new pryActualizaS111.ClsConectaS111();

            //        mcnsS111N = new N_ActualizaS111.ClsConectaS111();

            //        //AIS-1146 NGONZALEZ
            //        string tempStr = Seguridad.usugUsuario.NominaS;
            //        //mcnsS111.set_Usuario(ref tempStr);
            //        //mcnsS111N.set_Usuario(ref tempStr);
            //        //if (mcnsS111.FnPreguntaPwd())
            //        //{
            //        NobjConsulta = new N_TransS111.ClsConsulta();
            //        objConsulta = new TransS111.ClsConsulta();
            //        frmLoginS53 frmFirma = new frmLoginS53();
            //        var regreso = frmFirma.ShowDialog();
            ...
            //        if (regreso == DialogResult.OK)
            //        {
            //            //Seguridad.usugUsuario.NominaS = mcnsS111.NominaS;
            //            //Seguridad.usugUsuario.NombreS = mcnsS111.NombreS;
            //            //MessageBox.Show(mcnsS111.LeyendaS, "Sistema S111", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //            mprLog("Sesion S111 Aceptada.");
            //            result = true;
            //        }
            //        else
        ...
        {
            bool result = false;
            result = !mcnsS111N.FnDesconectarS111();
        ...
        public int ActualizaLimiteCredI(prySeguridadS041._clsAccion accpAccion, decimal cpNuevoLimiteCred, prySeguridadS041.topTipoOperMakerChecker epModoOp)
        {
            ...
            if (accpAccion == null)
            {
                MessageBox.Show("No se ha determinado una acción.", "Actualiza Límite de Uso", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return 0;
            }
            ...
            if (epModoOp == prySeguridadS041.topTipoOperMakerChecker.topChecker)
            {
                ...
                spParametros = " 1, " + msPrefijo + ", " + msBanco + ", " + msEmpresa + ", " + msEjecutivo;
                if (mdlADO.fncVerificaConexionM111b())
                {
                    mcLimiteCredNuevo = cpNuevoLimiteCred;
        ...
        private TransS111.EnumRespTransaccion ActualizaS111(trnTransacciones ptrnTransaccion)
        {
            ...
            try
            {
                if (ptrnTransaccion == trnTransacciones.trnActualizaLimite)
                {
                    ...
                    //mcnsS111.StrNoCuenta = msCuenta;
                    //mcnsS111.StrIdTransaccion = ((int)trnTransacciones.trnActualizaLimite).ToString();
                    //mcnsS111.StrParametrosAdicionales = Convert.ToInt32(mcLimiteCredNuevo).ToString();
                    mcnsS111N.StrNoCuenta = msCuenta;
                    mcnsS111N.StrIdTransaccion = ((int)trnTransacciones.trnActualizaLimite).ToString();
                    mcnsS111N.StrParametrosAdicionales = Convert.ToInt32(mcLimiteCredNuevo).ToString();
                    //AIS-1119 NGONZALEZ
                    String tempString = String.Empty;
                    //result = mcnsS111.FnEnviarTransaccion(ref tempString, ref tempString, ref tempString);
                    //if (mcnsS111.RespuestaS.IndexOf("OPERADOR NO AUTORIZADO") >= 0)
                    ...
                    mprLog(mcnsS111N.StrIdTransaccion + " " + msCuenta + " " + Convert.ToInt32(mcLimiteCredNuevo).ToString());
                    mprLog(mcnsS111N.RespuestaS);
        ...
        private int ActualizaM111(ADODB.Connection cnnpConexion)
        {
            ...
            try
            {
                ...
                if (cnnpConexion.State != 0)
                {
                    ...
                    slSQL = slSQL + "   emp_acum_cred = (select sum(eje_limcred) from MTCEJE01" + "\n";
                    slSQL = slSQL + "                 WHERE " + "\n";
                    slSQL = slSQL + "                     eje_prefijo = MTCEMP01.eje_prefijo" + "\n";
                    slSQL = slSQL + "                 AND gpo_banco = MTCEMP01.gpo_banco " + "\n";
                    slSQL = slSQL + "                 AND emp_num = MTCEMP01.emp_num)" + "\n";
                    ...
                    slSQL = slSQL + "   UPDATE MTCLIM02 SET" + "\n";
                    slSQL = slSQL + "   lim_est_lim_uso = 2" + "\n";
                    slSQL = slSQL + "   WHERE " + "\n";
                    slSQL = slSQL + "       eje_prefijo = " + msPrefijo + "\n";
                    slSQL = slSQL + "   AND gpo_banco = " + msBanco + "\n";
                    slSQL = slSQL + "   AND emp_num = " + msEmpresa + "\n";
                    slSQL = slSQL + "   AND eje_num = " + msEjecutivo + "\n";
                    slSQL = slSQL + "   AND lim_est_lim_uso in (0,1)" + "\n";
        ...
        public int EliminaMakerI(ADODB.Connection cnnpConexion)
        {
            ...
            string slSQL = String.Empty;
            int lira = 0;
            if (MessageBox.Show("¿Esta seguro de Eliminar la Solicitud de cambio de Límite de Uso para la cuenta " + msCuenta + "?", "Eliminar Solicitud de Cambio de Límite de Crédito", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {
                if (cnnpConexion.State != 0)
                {
                    //Elimina el registro de la tabla de MTCLIM02
                    slSQL = "SET ROWCOUNT 1" + "\n";
                    slSQL = slSQL + "BEGIN TRAN" + "\n";
                    slSQL = slSQL + "   DELETE FROM MTCLIM02 " + "\n";
                    slSQL = slSQL + "   WHERE " + "\n";
                    slSQL = slSQL + "       eje_prefijo = " + msPrefijo + "\n";
                    slSQL = slSQL + "   AND gpo_banco = " + msBanco + "\n";
                    slSQL = slSQL + "   AND emp_num = " + msEmpresa + "\n";
                    slSQL = slSQL + "   AND eje_num = " + msEjecutivo + "\n";
                    slSQL = slSQL + "   AND lim_est_lim_uso = 0" + "\n";
                    //slSQL = slSQL + "   AND lim_cta_bnx = '" + msCuenta + "'" + "\n";
                    slSQL = slSQL + "COMMIT TRAN" + "\n";
                    slSQL = slSQL + "SET ROWCOUNT 0" + "\n";
                    object tempRefParam = lira;
                    cnnpConexion.Execute(slSQL, out tempRefParam, -1);
                    result = lira;
                }
        ...
        private void mckrCambiaLimCred_Checker(ref  bool bpAutorizado, ref  prySeguridadS041.enuOperaciones epOperacionSol, ref  prySeguridadS041.clsMaker mkrpMaker)
        {
            ...
            {
                mprLog("No se actualizó el límite de uso debido a:");
                mprLog("Respuesta S111: " + mcnsS111.RespuestaS);
            }
        ...
        private void mckrCambiaLimCred_PostChecker(ref  bool bpAutorizado, ref  prySeguridadS041.topTipoOperMakerChecker ipOperacionRealizada, ref  prySeguridadS041.clsMaker mkrMaker, ref  prySeguridadS041.enuOperaciones epOperacionSol)
        {
            if (!bpAutorizado)
            {
                MessageBox.Show("Usted no puede completar el proceso de Cambio de Límite de Uso" + "\n" +
                    ...
                    "Autorización Límite de Uso", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void mckrCambiaLimCred_Validate(ref  short ipContinuarFlujo)
        {
            ...
            if (bfncValidaCuenta(true))
            {
                if (mcnsS111 == null)
                {
                    MessageBox.Show("La conexión al sistema S111 no es válida.", "Actualiza Límite de Uso.", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    ipContinuarFlujo = 1;
        ...
        private void mmkrCambiaLimCred_Maker(ref  ADODB.Connection cnnpConexion, ref  bool bpContinuar)
        {
            ...
            try
            {
                ...
                slSQL = "SELECT lim_cred_ant," + "\n";
                slSQL = slSQL + " lim_cred_nvo," + "\n";
                slSQL = slSQL + " lim_nomina_maker," + "\n";
                slSQL = slSQL + " lim_nombre_maker," + "\n";
                slSQL = slSQL + " lim_fecha_maker FROM MTCLIM02" + "\n";
                slSQL = slSQL + "WHERE " + "\n";
                slSQL = slSQL + "    eje_prefijo = " + msPrefijo + "\n";
                slSQL = slSQL + " AND gpo_banco = " + msBanco + "\n";
                slSQL = slSQL + " AND emp_num = " + msEmpresa + "\n";
                ...
                if (!(rst.BOF && rst.EOF))
                {
                    elReemplazar = MessageBox.Show("El cambio de Límite de uso para la cuenta " + msCuenta +
                                   "\r\n" + "fué solicitado por " + Convert.ToString(rst.Fields["lim_nombre_maker"].Value) +
                                   "\r\n" + "de " + StringsHelper.Format(rst.Fields["lim_cred_ant"].Value, "Currency") + " a " + StringsHelper.Format(rst.Fields["lim_cred_nvo"].Value, "Currency") +
                                   "\r\n" + "el día " + Convert.ToString(rst.Fields["lim_fecha_maker"].Value) + "\r\n" + "\r\n" + "¿Desea que la solicitud de Límite de Uso se actualice a " + StringsHelper.Format(mcLimiteCredNuevo, "Currency") + "?", "Solicitud de Cambio de Límite de Uso", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (elReemplazar == System.Windows.Forms.DialogResult.Yes)
                    {
                        ...
                        slSQL = slSQL + " lim_cred_nvo = " + mcLimiteCredNuevo.ToString() + "," + "\r\n";
                        slSQL = slSQL + " lim_nomina_maker = '" + mmkrCambiaLimCred.UsuarioUSU.NominaS + "', " + "\r\n";
                        slSQL = slSQL + " lim_nombre_maker = '" + mmkrCambiaLimCred.UsuarioUSU.NombreS + "', " + "\r\n";
                        slSQL = slSQL + " lim_fecha_maker = getdate()" + "\r\n";
                ...
                else
                {
                    ...
                    //slSQL = slSQL + "And eje_prefijo = " + msPrefijo + "\r\n";
                    //slSQL = slSQL + "And gpo_banco = " + msBanco + "\r\n";
                    //slSQL = slSQL + "INSERT INTO MTCLIM02 (" + "\r\n";
                    ...
                    slSQL = "declare @limite_uso_ant int" + "\r\n";
                    slSQL = slSQL + "declare @ID int" + "\r\n";
                    slSQL = slSQL + "SELECT" + "\r\n";
                    slSQL = slSQL + "    @limite_uso_ant = eje_limcred" + "\r\n";
                    slSQL = slSQL + "From MTCEJE01" + "\r\n";
                    slSQL = slSQL + "Where emp_num = " + msEmpresa + "\r\n";
                    slSQL = slSQL + "And eje_num = " + msEjecutivo + "\r\n";
                    slSQL = slSQL + "And eje_prefijo = " + msPrefijo + "\r\n";
                    slSQL = slSQL + "And gpo_banco = " + msBanco + "\r\n";
                    slSQL = slSQL + "SELECT @ID = isnull(MAX(lim_id),0) +1 from MTCLIM02" + "\r\n";
                    slSQL = slSQL + "INSERT INTO MTCLIM02" + "\r\n";
                    slSQL = slSQL + "(lim_id," + "\r\n";
                    slSQL = slSQL + "eje_prefijo," + "\r\n";
                    slSQL = slSQL + "gpo_banco," + "\r\n";
                    slSQL = slSQL + "emp_num," + "\r\n";
                    slSQL = slSQL + "eje_num," + "\r\n";
                    slSQL = slSQL + "eje_roll_over," + "\r\n";
                    slSQL = slSQL + "eje_digit," + "\r\n";
                    slSQL = slSQL + "lim_cred_ant," + "\r\n";
                    slSQL = slSQL + "lim_cred_nvo," + "\r\n";
                    slSQL = slSQL + "lim_nomina_maker," + "\r\n";
                    slSQL = slSQL + "lim_nombre_maker," + "\r\n";
                    slSQL = slSQL + "lim_fecha_maker," + "\r\n";
                    slSQL = slSQL + "lim_est_lim_uso)" + "\r\n";
                    slSQL = slSQL + "Values" + "\r\n";
                    slSQL = slSQL + "(@ID," + "\r\n";
                    slSQL = slSQL + msPrefijo + ", " + "\r\n";
                    slSQL = slSQL + msBanco + ", " + "\r\n";
                    slSQL = slSQL + msEmpresa + ", " + "\r\n";
                    slSQL = slSQL + msEjecutivo + ", " + "\r\n";
                    slSQL = slSQL + msRollOver + ", " + "\r\n";
                    slSQL = slSQL + msDigitoVerificador + ", " + "\r\n";
                    slSQL = slSQL + "@limite_uso_ant, " + "\r\n";
                    slSQL = slSQL + mcLimiteCredNuevo.ToString() + ", " + "\r\n";
                    slSQL = slSQL + "'" + mmkrCambiaLimCred.UsuarioUSU.NominaS + "', " + "\r\n";
                    slSQL = slSQL + "'" + mmkrCambiaLimCred.UsuarioUSU.NombreS + "', " + "\r\n";
                    slSQL = slSQL + "getdate(), " + "\r\n";
