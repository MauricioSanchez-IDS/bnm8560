...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        clsAltaTarjetahabiente ConsultaS111 = null;
        ...
        private void Cormn111_Closed(Object eventSender, EventArgs eventArgs)
        {
            ...
            if (bConexion)
            {
                int termina = RUT_Disconnect(false);
        ...
        private void ID_MEE_OK_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            ConsultaS111 = new clsAltaTarjetahabiente();
            ...
            try
            {
                ...
                pszRespuesta = ConsultaS111.fncConsultaS111EjeComDrv(ID_MEE_NUCS111_EB.Text, out slConsulta);
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_MEE_OK_PB_Click)", e);
            }
        }
