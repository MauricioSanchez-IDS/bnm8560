...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        FarPoint.Win.Spread.CellType.EditBaseCellType CorCell = new FarPoint.Win.Spread.CellType.EditBaseCellType();
        ...
        private void Calcula_totales(int iMaxRenglones)
        {
            ...
            //Totales
            ID_CGR_REP_SS.Col = 2;
            ID_CGR_REP_SS.CellType = CorCell;
            ID_CGR_REP_SS.TypeHAlign = 0;
            ...
            //ID_CGR_REP_SS..TypeHAlign = (FPSpreadADO.TypeHAlignConstants)1;;
            //ID_CGR_REP_SS.TypeFloatSeparator = true;
        ...
        private void Carga_Reporte()
        {
            ...
            CORVAR.pszgblsql = "spdbrp_conc_gpo_emp " + Conversion.Str(CORVAR.igblPref) + "," + Conversion.Str(CORVAR.igblBanco) + "," + Conversion.Str(CORVAR.lgblGpoCve) + "," + Formato.ifncMes(CORVAR.igblMesCorte).ToString() + "," + Conversion.Str(CORVAR.igblAñoCorte);
            ...
            if (CORPROC2.Obtiene_Registros() != 0)
            {
                ...
                while (VBSQL.SqlNextRow(CORVAR.hgblConexion) != VBSQL.NOMOREROWS)
                {
                    ...
                    //    {
                    iNumTarjetas = Convert.ToInt32(Conversion.Val(VBSQL.SqlData(CORVAR.hgblConexion, 9)));
                    //    }
                    //}
                    //Realiza fin de Query
                    ...
                    //    if (VBSQL.SqlNextRow(CORVAR.hgblConexion2) == VBSQL.MOREROWS)
                    //    {
                    iNumTarAtr = Convert.ToInt32(Conversion.Val(VBSQL.SqlData(CORVAR.hgblConexion, 8)));
                    //    }
                    //}
                    //Realiza fin de Query
                    //lRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion2);
                    ...
                    //    if (VBSQL.SqlNextRow(CORVAR.hgblConexion2) == VBSQL.MOREROWS)
                    //    {
                    dDispEfec = Conversion.Val(VBSQL.SqlData(CORVAR.hgblConexion, 12));
                    //    }
                    //}
                    //Realiza fin de Query
                    //lRetorna = VBSQL.SqlCancel(CORVAR.hgblConexion2);
        ...
        private void Formatea_Spread()
        {
            ...
            ID_CGR_REP_SS.Col = 1;
            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.set_ColWidth(1, 8*8);
            ID_CGR_REP_SS.Text = "  No.  ";

            ID_CGR_REP_SS.Col = 2;
            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.set_ColWidth(2, 25*8);
            ID_CGR_REP_SS.Text = "Empresa";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 3;
            ID_CGR_REP_SS.set_ColWidth(3, 7*8);
            ID_CGR_REP_SS.Text = "# Tarjs.";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 4;
            ID_CGR_REP_SS.set_ColWidth(4, 12*8);
            ID_CGR_REP_SS.Text = "Límite";


            //ID_CGR_REP_SS.Row = 0;
            //ID_CGR_REP_SS.Col = 5;
            //ID_CGR_REP_SSset_ColWidth(5, 7);
            //ID_CGR_REP_SS.ColHidden = True
            //ID_CGR_REP_SS.Text = "# Atras.";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 5;
            //ID_CGR_REP_SS.set_ColWidth(6, 12);
            ID_CGR_REP_SS.set_ColWidth(5, 12*8);
            ID_CGR_REP_SS.Text = "Saldo Anterior";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 6;
            ID_CGR_REP_SS.set_ColWidth(6, 12*8);
            ID_CGR_REP_SS.Text = "Consumos";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 7;
            ID_CGR_REP_SS.set_ColWidth(7, 12*8);
            ID_CGR_REP_SS.Text = "Disp. Efvo.";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 8;
            ID_CGR_REP_SS.set_ColWidth(8, 12*8);
            ID_CGR_REP_SS.Text = "Pagos";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 9;
            ID_CGR_REP_SS.set_ColWidth(9, 12*8);
            ID_CGR_REP_SS.Text = "Comisiones";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 10;
            ID_CGR_REP_SS.set_ColWidth(10, 12*8);
            ID_CGR_REP_SS.Text = "Gtos. Cobr.";

            //ID_CGR_REP_SS.Row = 0;
            //ID_CGR_REP_SS.Col = 11;
            //ID_CGR_REP_SS.set_ColWidth(12, 12);
            //ID_CGR_REP_SS.Text = "I.V.A.";

            ID_CGR_REP_SS.Row = 0;
            ID_CGR_REP_SS.Col = 11;
            ID_CGR_REP_SS.set_ColWidth(11, 12*8);
        ...
        private void Llena_Detalle(int iRenglon)
        {
            ...
            ID_CGR_REP_SS.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            ID_CGR_REP_SS.TypeFloatSeparator = true;
            ID_CGR_REP_SS.Text = StringsHelper.Format(dSaldoAnterior, "##,###,###,##0.00");
            ...
            ID_CGR_REP_SS.TypeHAlign = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            ID_CGR_REP_SS.TypeFloatSeparator = true;
            ID_CGR_REP_SS.Text = StringsHelper.Format(dSaldoNuevo, "##,###,###,##0.00");
