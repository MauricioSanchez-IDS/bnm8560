...
namespace TCd430
{
	internal partial class frmReenvEjecutivo
		: System.Windows.Forms.Form
		{
			...
			//UPGRADE_NOTE: (7001) The following declaration (prLlenaCentroC) seems to be dead code
			//private void  prLlenaCentroC( Control ctrlpControl)
			//{
					//int llRegistros = 0;
					...
					//{
							//
							//cmblCombo = (ComboBox) ctrlpControl;
					...
					//{
						...
						//} else
						//{
							//CRSGeneral.prObtenError("frmReenvEjecutivo (LlenaCentroC)");
							//return;
						//}
					//}
					//
			...
			//UPGRADE_NOTE: (7001) The following declaration (fncObtenValoresEjecutivoB) seems to be dead code
			...
			//{
					...
					//{
							//
							//switch(ipTipoConsulta)
							//{
								//case mdlEjecutivo.enuTipoConsultaEjecutivo.tcneConsultaAlta : 
									// 
									//CORVAR.pszgblsql = "select"; 
									...
									// 
									//break;
								//case mdlEjecutivo.enuTipoConsultaEjecutivo.tcneConsultaCambio : 
									//break;
								//case mdlEjecutivo.enuTipoConsultaEjecutivo.tcneConsultaConsulta : 
									//break;
							//}
						//}
					//catch 
					//{
						...
						//} else
						//{
							//CRSGeneral.prObtenError("frmReenvEjecutivo  (ObtenValoresEjecutivo)");
							//return result;
						//}
					//}
					//
			...
			//UPGRADE_NOTE: (7001) The following declaration (prLlenaSubActividad) seems to be dead code
			...
			//{
					...
					//{
						...
						//} else
						//{
							//CRSGeneral.prObtenError("frmReenvEjecutivo (LlenaSubActividad)");
							//return;
						//}
					//}
					//
			...
			//UPGRADE_NOTE: (7001) The following declaration (fncEnviaValidaDialogoB) seems to be dead code
			//private bool fncEnviaValidaDialogoB( mdlEjecutivo.enuTipoAltaSistema ipTipoAlta)
			//{
					//
					//bool result = false;
					//string slRespMensaje = String.Empty;
					//string slClaveRespTransaccion = String.Empty;
					//string slClaveTransaccion = String.Empty;
					//string slRespuestaS111 = String.Empty;
					//string slDescResp = String.Empty;
					...
					//{
							...
							//result = false;
							//
							//if (ipTipoAlta == mdlEjecutivo.enuTipoAltaSistema.tasAltaS111)
							//{ //***** ALTA S111 *****
								//
								...
								//{
									//slClaveRespTransaccion = Strings.Mid(slRespMensaje, 32, 2);
									//slClaveTransaccion = Strings.Mid(slRespMensaje, 34, 4);
									//
									//slRespuestaS111 = Strings.Mid(slRespMensaje, 38, 30);
									//slDescResp = Strings.Mid(slRespMensaje, 50, 78).Trim();
									//
									//if ((("0123456789").IndexOf(Strings.Mid(slClaveRespTransaccion, 1, 1)) + 1) == 0)
									//{
										//MessageBox.Show("Existe un error de comunicaciones. Avise a sistemas", AssemblyHelper.GetTitle(System.Reflection.Assembly.GetExecutingAssembly()), MessageBoxButtons.OK, MessageBoxIcon.Information);
										//result = false;
										//this.Cursor = Cursors.Default;
										//return result;
									//}
									//
									//if ((slClaveRespTransaccion == "04" || slClaveRespTransaccion == "05") && slRespuestaS111 == CORVB.NULL_STRING)
									//{
										//slClaveRespTransaccion = "01";
									//}
									//
									//if (slRespuestaS111.Trim() == "0030")
									//{ //Existe en el S111
										//if (fncVerificaConsultaB(mdlEjecutivo.enuTipoAltaSistema.tasAltaS111))
										//{
										...
										//} else
										//{
											//prActualizaEstatus(12);
											//MessageBox.Show("Ya existe la cuenta " + gdteEjecutivo.EjeCuentaBnxS + " en el S111. Avisar a Ing. de Sistemas", "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Error);
											//result = false;
											//this.Cursor = Cursors.Default;
											//return result;
										//}
									//}
									//
									//switch(slClaveRespTransaccion)
									//{
										//case "00" : 
											//prActualizaEstatus(3); 
											//if (fncActualizaConsecutivoB())
											//{
												//prActualizaEstatus(6);
												//if (fncVerificaConsultaB(mdlEjecutivo.enuTipoAltaSistema.tasAltaS111))
												//{
													//prActualizaEstatus(8);
													//result = true;
										...
										//case "01" : case "03" : 
											//result = false; 
											//MessageBox.Show("El servidor CONALTAS no esta disponible", "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Information); 
											//this.Cursor = Cursors.Default; 
											// 
											//break;
										//case "02" : 
											//result = false; 
											//MessageBox.Show(slDescResp, "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Error); 
											//this.Cursor = Cursors.Default; 
											// 
											//break;
										//case "05" : 
											//prActualizaEstatus(4); 
											//if (fncActualizaConsecutivoB())
											//{
												//MessageBox.Show(slDescResp, "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Error);
												//result = false;
											...
											//break;
										//case "06" : 
											//if (slDescResp.Trim().ToUpper() != "CONTRATO A DAR DE ALTA YA EXISTE")
											//{
												//result = false;
												//MessageBox.Show(slDescResp, "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Error);
												//this.Cursor = Cursors.Default;
										...
										//default:
											...
											//} else
											//{
												//MessageBox.Show("Mensaje de respuesta del diálogo " + "\r\n" + fncObtenErrorDialogoS(Convert.ToInt32(Conversion.Val(slClaveRespTransaccion)), mdlConexiones.enuTipoSistema.tsistSistemaTandem), Application.ProductName);
												//result = false;
												//this.Cursor = Cursors.Default;
												//return result;
											//}
								...
								//} else
								//{
									//MessageBox.Show("Existe un error en el TANDEM No.: " + " ilRespuestaEnvio " + "\r\n" + fncObtenErrorDialogoS(ilRespuestaEnvio, mdlConexiones.enuTipoSistema.tsistSistemaTandem), "Tarjeta Corporativa", MessageBoxButtons.OK, MessageBoxIcon.Information);
									//if (fncVerificaConsultaB(mdlEjecutivo.enuTipoAltaSistema.tasAltaS111))
									//{
										//prActualizaEstatus(8);
										//result = true;
					...
					//{
						...
						//} else
						//{
							//CRSGeneral.prObtenError("frmReenvEjecutivo (EnviaValidaDialogo)");
							//result = false;
							//this.Cursor = Cursors.Default;
							//return result;
						//}
					...
					try
					{
							...
							{ //***** CONSULTA S111 *****
								...
								if (ilRespuestaEnvio != 0)
								{
									...
									MessageBox.Show("Error en el envio de la informacion.", "Tarjeta Ejecutiva", MessageBoxButtons.OK, MessageBoxIcon.Error);
									result = false;
									this.Cursor = Cursors.Default;
									return result;
								} else
		...
		*/
            ...
            private void ConsultaMTCMSV(Softtek.Util.Win.Spread.SpreadWrapper Grid)
			{
					...
					try
					{
							...
							Grid.BlockMode = true;
							//Grid.Action =  (FPSpreadADO.ActionConstants)3;
                            Grid.Clear();
							...
							{
                                Grid.set_ColWidth(iCont, int.Parse(Grid.get_MaxTextColWidth(iCont).ToString()) * 3);
							}
							this.Cursor = Cursors.Default;
			...
			private void  cmdConsMasivo_Click( Object eventSender,  EventArgs eventArgs)
			{
					...
					try
					{
                        //AIS-541 NGONZALEZ
							...
							ConsultaMTCMSV(gridRegistros);
							if (colReenv_Eje.Count > 0)
							{
								cmdReenvio.Enabled = true;
								sTipConsulta = "MTCMSV02";
							} else
							{
								cmdReenvio.Enabled = false;
							}
                            gridRegistros.Row = 1;
                            gridRegistros.Col = 1;
                            //gridRegistros.Action = 0;
                            gridRegistros.Clear();
                            FarPoint.Win.Spread.CellClickEventArgs e1 = new FarPoint.Win.Spread.CellClickEventArgs(new FarPoint.Win.Spread.SpreadView(fpsgridRegistros), 1, 1, 0, 0, MouseButtons.Left, false, false);
                            object sender1 = null;
                            gridRegistros_Click(sender1, e1);
			...
			private void  prLimpiaGrid()
			{
					...
					try
					{
							...
							//gridRegistros.Action =  (FPSpreadADO.ActionConstants)3;
                            gridRegistros.Clear();
			...
			private void  cmdConsIndividual_Click( Object eventSender,  EventArgs eventArgs)
			{
                    ...
                    {//AIS-541 NGONZALEZ
                        ...
                        //AIS-541 NGONZALEZ
							colReenv_Eje = new colReenvioEjec();
							ConsultaMTCIND(gridRegistros, colReenv_Eje);
							if (colReenv_Eje.Count > 0)
							{
								cmdReenvio.Enabled = true;
								sTipConsulta = "MTCIND02";
							} else
							{
								cmdReenvio.Enabled = false;
							}
			...
			private bool fncReenvioEjecutivosB( int iIndxItem)
			{
					...
					try
					{
							...
							//    Select Case Estatus
							//        Case 0, 1, 2, 5
							//            If fncObtenEjeNumB = True Then
							//                prActualizaEstatus 1
							//                igIndAltaCteOK = 0
							//                gdlgDialogoS111.prGeneraDlg gdteEjecutivo, tAltaEjecutivoS111
							//                If fncValorOmisionV(fncEnviaValidaDialogoB(tasAltaS111), False) = True Then
							//                   If fncInsertaEjecutivoM111B = True Then
							//                        prActualizaEstatus 9
							//                        If fncActualizaCredAcumEmpB = True Then
							//                            prActualizaEstatus 10
							//                            If fncConsultaEjecutivoM111B = True Then
							//                                prActualizaEstatus 11
							...
							//                                fncEliminaEjecutivoRespB
							//                                fncReenvioEjecutivosB = True
							//                                Screen.MousePointer = vbDefault
							//                                Exit Function
							//                            Else
							//                                fncReenvioEjecutivosB = False
							//                                Screen.MousePointer = vbDefault
							//                                Exit Function
							//                            End If
							//                        Else
							...
							//        Case 4
							//            igIndAltaCteOK = 1
							//            If fncActualizaConsecutivoB = True Then
							//                prActualizaEstatus 6
							//
							//                gdlgDialogoS111.prGeneraDlg gdteEjecutivo, tAltaEjecutivoS111
							//
							//                cnxConexionRut.Termina_Conexion
							//
							//                If cnxConexionRut.Inicia_Conexion = False Then
							//                    fncReenvioEjecutivosB = False
							...
							//            End If
							//
							//            If fncVerificaConsultaB(tasAltaS111) = True Then
							//                prActualizaEstatus 8
							//                If fncInsertaEjecutivoM111B = True Then
							//                    prActualizaEstatus 9
							//                    If fncActualizaCredAcumEmpB = True Then
            ...
            private void gridRegistros_Click(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
            {
                object pvStatus;
                ...
                if (e != null && e.Row > 0)
                {
                    if (gridRegistros.GetText(5, e.Row, ref pvStatus))
                    {
                        if (pvStatus.ToString() == "")
                        {
                            pvStatus = "0";
                        }
                        CRSGeneral.prSemaforoReenvios(ref shpS016, ref shpS111, ref shpC430, ref shpComplementaria, CRSGeneral.enmSemaforoModulos.SMD_TARJETAHABIENTE, Convert.ToInt32(pvStatus));
                    }
                    else
                    {
                        CRSGeneral.prSemaforoReenvios(ref shpS016, ref shpS111, ref shpC430, ref shpComplementaria, CRSGeneral.enmSemaforoModulos.SMD_TARJETAHABIENTE, -1);
                    }
                }
            }

            private void gridRegistros_LeaveCell(object sender, FarPoint.Win.Spread.LeaveCellEventArgs e)
            {
                //AxFPSpreadADO._DSpreadEvents_ClickEvent e1 = new AxFPSpreadADO._DSpreadEvents_ClickEvent(e.newCol, e.newRow);
                //gridRegistros_Click(sender, e1);
            }
