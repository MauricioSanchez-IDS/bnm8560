...
namespace TCd430
{
	internal partial class CORSGPRE
		: System.Windows.Forms.Form
		{
            ...
            public void CORSGPRE_Closing(Object eventSender, CancelEventArgs eventArgs)
            {
                ...
                try
                {
                    if (CORPROC.ModuloEnUso("Tarjeta Ejecutiva Banamex") != 0)
                    {
                        Interaction.AppActivate("Tarjeta Ejecutiva Banamex");
                        //AIS-1182 NGONZALEZ
                        CORVAR.igblErr = API.USER.PostMessage(CORSGPRE.DefInstance.Handle.ToInt32(), CORVB.WM_CLOSE, CORVB.NULL_INTEGER, CORVB.NULL_INTEGER);
                        return;
                    }
            ...
            private void ID_MDI_TIM_TMR_Tick(Object eventSender, EventArgs eventArgs)
            {
                ...
                //bool eventArgs1 = true;
                //CORSGPRE_Closing(eventSender, new CancelEventArgs(eventArgs1));
                //DoEvents
            }
