...
namespace TCd430
{
        ...
        : System.Windows.Forms.Form
    {
        ...
        private void ID_CEB_ALT_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_CEB_ALT_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_CEB_BAJ_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_CEB_BAJ_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_CEB_CAM_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_CEB_CAM_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_CEB_CON_PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_CEB_CON_PB_Click)", e);
            }
            finally
            {
                this.Cursor = Cursors.Default;
        ...
        private void ID_CEB_MAS_3PB_Click(Object eventSender, EventArgs eventArgs)
        {
            ...
            {
                CRSGeneral.prObtenError(this.GetType().Name + "(ID_CEB_MAS_3PB_Click)", e);
            }
        ...
        private void Realiza_baja()
        {
            ...
            this.Cursor = Cursors.WaitCursor;
            Interaction.MsgBox("No es factible realizar la baja porque existe una restricción. Consulte a su Administrador", (MsgBoxStyle)(((int)CORVB.MB_ICONEXCLAMATION) + ((int)CORVB.MB_OK)), CORSTR.STR_APP_TIT);
            this.Cursor = Cursors.Default;
            //Obtiene los campos de la tabla de Ejecutivos Banemex
        ...
        private void CORCTEJB_Load(object sender, EventArgs e)
        {
