...
namespace TCd430
{
	class CRSGeneral
	{
        ...
        public enum enmStatusEmpresa
        {
           semIniciaAlta = 0,
           semS016OK = 1,
           semS016OKS111OK = 2,
           semS016OKS111OKC430 = 3,
           semAltaOKComp = 4,
           semFaltaS111C430 = 5,
           semFaltaElimReg = 7,
           semFaltaAltaEje = 8,
        ...
        public enum enmSemaforoModulos
        {
            SMD_EMPRESAS,
            SMD_TARJETAHABIENTE
        }

        static public void prSemaforoReenvios(ref PictureBox rshpS016, 
                                       ref PictureBox rshpS111, 
                                       ref PictureBox rshpC430,
                                       ref PictureBox rshpComplementaria,
                                       enmSemaforoModulos asmdModulo,
                                       int aiStatus)
        {
            switch (asmdModulo)
            {
                case enmSemaforoModulos.SMD_EMPRESAS:
                switch (aiStatus)
                {
                    case (int)enmStatusEmpresa.semIniciaAlta:  //'0
                        rshpS016.BackColor = Color.Red;
                        rshpS111.BackColor = Color.Red;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)enmStatusEmpresa.semS016OK:      //'1
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Yellow;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)enmStatusEmpresa.semS016OKS111OK:    //'2
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)enmStatusEmpresa.semS016OKS111OKC430:    //'3
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Yellow;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)enmStatusEmpresa.semAltaOKComp:  //'4
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.DarkKhaki;
                        break;
                    case (int)enmStatusEmpresa.semFaltaS111C430:   //'5
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Red;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)enmStatusEmpresa.semFaltaElimReg:    //'7
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.Green;
                        break;
                    case (int)enmStatusEmpresa.semFaltaAltaEje:    //'8
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Yellow;
                        rshpComplementaria.BackColor = Color.DarkOrange;
                        break;
                    case (int)enmStatusEmpresa.steAltaOKConsEje:   //'9
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.DarkOrange;
                        break;
                    case (int)enmStatusEmpresa.semDirCreado:      //'10
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.Yellow;
                        break;
                    default:
                        rshpS016.BackColor = Color.Silver;
                        rshpS111.BackColor = Color.Silver;
                        rshpC430.BackColor = Color.Silver;
                        rshpComplementaria.BackColor = Color.Silver;
                        break;
                }
                break;
                case enmSemaforoModulos.SMD_TARJETAHABIENTE:
                switch (aiStatus)
                {
                    case (int)CRSParametros.enmStatusPaso.SPS_GRABADO_PASO:
                        rshpS016.BackColor = Color.Red;
                        rshpS111.BackColor = Color.Red;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_S016_2:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Yellow;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_S016_S111_1:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_S016_S111_2:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Yellow;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_C430:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_S016_1:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Red;
                        rshpC430.BackColor = Color.Red;
                        rshpComplementaria.BackColor = Color.Red;
                        break;
                    case (int)CRSParametros.enmStatusPaso.SPS_ALTA_FINAL:
                        rshpS016.BackColor = Color.Green;
                        rshpS111.BackColor = Color.Green;
                        rshpC430.BackColor = Color.Green;
                        rshpComplementaria.BackColor = Color.Green;
